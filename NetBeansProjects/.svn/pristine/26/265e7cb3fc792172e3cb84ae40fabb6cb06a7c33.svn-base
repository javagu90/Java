                            ...
                            .add(jPanel1Layout.createSequentialGroup()
                                ...
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                                        .add(jTxtFechaFinal, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 94, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED))
                                    .add(jPanel1Layout.createSequentialGroup()
                                        .add(jLabel10)
                                        .add(38, 38, 38)))
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel1Layout.createSequentialGroup()
                                ...
                                .add(440, 440, 440))
                            .add(jPanel1Layout.createSequentialGroup()
                                .add(jTxtNombreOperador, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 496, Short.MAX_VALUE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)))
                    ...
                    .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        ...
                        .add(jPanel1Layout.createSequentialGroup()
                            ...
                            .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                .add(jPanel1Layout.createSequentialGroup()
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(jTxtValorIncidencia, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 21, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
...
// TODO add your handling code here:
    ...
    private void registrarIncidencia() {
     ...
     // BRA   tmsOperadorIncidenciasTbl.setAdicional2(obsParte2);
       ...
       // Si es Utorizada y requiere Aplicar en Recauda
        if(tmsOperadorIncidenciasTbl.getIncidenciaAutorizada().equals("S") && sesionVenta.AplicaRecauda_Inc(jCboClaveIncidencia.getSelectedItem().toString()))    
        {// if(tmsOperadorIncidenciasTbl.getIncidenciaAutorizada().equals("S")){  INCIDENCIA AUTORIZADA
            ...
            boolean fdatosAdiciEsp = sesionVenta.obtenerDatosAdicionalesEspeciales(jCboClaveIncidencia.getSelectedItem()+"");
             if (fdatosAdiciEsp){
            ...
            if(jDlgDatosAdicionales != null && jDlgDatosAdicionales.FDoOperacion)
                {   //    Guarda datos en Recaudacion
                   ...
                   if(!sesionVenta.ingresarPreIngresoEspecial(this.USUARIO_ID))
                         ...
                         if(sesionVenta.getTmsIncidenciasTbl().get(jCboClaveIncidencia.getSelectedIndex()-1).getAplicaRecaudacion().equals("S"))
                           {  DialogoAceptar = new JDlgAceptar("¡Autorizacion realizada correctamente!", "Pago preingresado en recaudacion.", Color.RED);        }  
                         else DialogoAceptar = new JDlgAceptar("¡Autorizacion realizada correctamente!", "Presione Enter para continuar...", Color.RED);
                ...
                } //  BRA  // IF  si doy datos adicionales
    ...
    private boolean validaDatosIngresados(){
        ...
        try {
            tmFecha = new Timestamp(formatoFecha.parse(jTxtFechaInicial.getText()).getTime());
        } catch (ParseException ex) {
            DialogoAceptar = new JDlgAceptar("¡Fecha inicial invalida!", "Ingrese fecha correcta.", Color.RED);
            return false;
        }
        try {
            tmFecha2 = new Timestamp(formatoFecha.parse(jTxtFechaFinal.getText()).getTime());
        } catch (ParseException ex) {
    ...
    private void autorizarIncidencia() {
      if(sesionVenta.getVwIncOper().get(sesionVenta.getFilaIncidenciaSeleccionada()).getIncidenciaAutorizada().equals("AUTORIZADA")){
        ...
        if(!DialogoSiNo.getResultado()) return;
        JDlgDatosAdicionales jDlgDatosAdicionales = null;
        if(sesionVenta.obtenerDatosAdicionales()){  /// aplic arecauda
             jDlgDatosAdicionales = new JDlgDatosAdicionales (sesionVenta);
            jDlgDatosAdicionales.setVisible(true);
        }
        if(jDlgDatosAdicionales !=  null && jDlgDatosAdicionales.FDoOperacion   )
        {    trace(" Datos Adicionales  "+sesionVenta.xDatosAdicionales()[0][2].length());
    ...
    private boolean operadorTieneIncidencias() {
        return sesionVenta.tieneIncidencia(jTxtNumeroOperador.getText(), jTxtFechaInicial.getText(), jTxtFechaFinal.getText());
    }
    ...
    private Object[] encabezado = {"Operador", "Incidencia", "Fecha Inicial", "Fecha Final", "Valor", "Servicio", "Estado"};
