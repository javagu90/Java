...
public class rc4 //extends Applet
{
   ...
   String sUser = "";
   String sPassw = "";
   public String semilla = "a123bcdef";
   ...
   public String Salaa(String plaintxt, String key)
   {
      ...
      int cipherby = 0;
      String cipher = "";
      //psw = "&h01 &h23 &h45 &h67 &h89 &hab &hcd &hef"; //kiinteä avain
      //RC4Initialize(psw);
   ...
   public String Avain()
   {
	...
	public String StringToHexString(String b){
      ...
      public String encriptar(String cadena){
          String enc = "";
          enc = Salaa( cadena,semilla);
          enc = StringToHexString(enc);
          //System.out.println("StringToHexString: "+enc);
          //System.out.println("hexStringToString: "+hexStringToString(enc));
          return enc;
      }

      public String desencriptar(String cadena){
          String enc = "";
          enc = hexStringToString(cadena);
          enc = Salaa( enc,semilla);
          return enc;
      }
}