        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    ...
                    .add(jLabel5))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jScpBoletoOriginal, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        if(evt.getKeyCode() == evt.VK_ENTER)
          {
                    ...
                    boletos = sesionVenta.buscaBoletoVendidoParaHOMult(jCboOrigen.getSelectedItem().toString(), 
                            ...
                            jCboEmpresas.getSelectedItem().toString().substring((jCboEmpresas.getSelectedItem().toString().indexOf("-")) + 1),
...
//                            jTblBoletoOriginal.repaint();
            ...
            case KeyEvent.VK_F12:
                ...
                else
                {
                    ...
                    if(viajado){
                        DialogoAceptar.mostrarDialogo("¡No es posible cambiar de horario el boleto!","El pasajero ya Viajó con este boleto.", Color.RED);
                        return;
                    }
                    ...
                    System.out.println("Cargo(HO): "+String.valueOf(cargo));
                    ...
                    if(cargo>0)
                    {
                        DialogoSiNo = new JDlgSiNo("¡Confirmacion!","<html><center><font size=+1>Se cobrara un cargo de  </font><font color="+ColoresInterfaz.cHTML3+" size=+2>$ "+sesionVenta.customFormat("##,##0.00",cargo)+"</font> <font size=+1>al cliente.             </center>Por concepto: </font><br><center><font color="+ColoresInterfaz.cHTML3+"> Cargo por Cambio de Horario</font></center><font size=+1>¿Desa continuar con el Cambio de Horario?</font></html>",true);
                        boolean res = DialogoSiNo.getResultado();
                        sesionVenta.setCobroCargo(res);
                        if(!res)
                            return;
                    }
...
//                    }
                ...
                break;
            case KeyEvent.VK_LEFT: case KeyEvent.VK_UP:
                    jchbx_bolRef.requestFocusInWindow();
                break;
            case KeyEvent.VK_RIGHT: case KeyEvent.VK_DOWN:
...
// TODO add your handling code here:
    ...
    private boolean validaCampos(){
        ...
        if(jTxtNoAsiento.getText().equals("") && !jchbx_bolRef.isSelected()){
