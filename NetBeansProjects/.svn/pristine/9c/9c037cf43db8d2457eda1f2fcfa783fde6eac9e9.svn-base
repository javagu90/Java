 ...
 */
@Remote
public interface wsRepControlFacadeBeanRemote {
    ...
    public ERTMSWS.clasesx.VenderBoletos.getAsociarTokensClienteResp getAsociarTokensCliente(ERTMSWS.clasesx.VenderBoletos.getAsociarTokensClienteReq req);

    public ERTMSWS.clasesx.VenderBoletos.getModificarTokenResp geModificarToken(ERTMSWS.clasesx.VenderBoletos.getModificarTokenReq req);

    public ERTMSWS.clasesx.VenderBoletos.getTokensClienteResp getTokensCliente(ERTMSWS.clasesx.VenderBoletos.getTokensClienteReq req);

    public WS_CONTROL.getAsociarDireccionClienteResp getAsociarDireccionCliente(WS_CONTROL.getAsociarDireccionClienteReq req);

    public WS_CONTROL.getModificarDireccionClienteResp getModificarDireccionCliente(WS_CONTROL.getModificarDireccionClienteReq req);

    public WS_CONTROL.getDireccionesClienteResp getDireccionesCliente(WS_CONTROL.getDireccionesClienteReq req);

    public WS_CONTROL.getAsociarDireccionFiscalClienteResp getAsociarDireccionFiscalCliente(WS_CONTROL.getAsociarDireccionFiscalClienteReq req);

    public WS_CONTROL.getModificarDireccionFiscalClienteResp getModificarDireccionFiscalCliente(WS_CONTROL.getModificarDireccionFiscalClienteReq req);

    public WS_CONTROL.getDireccionesFiscalesClienteResp getDireccionesFiscalesCliente(WS_CONTROL.getDireccionesFiscalesClienteReq req);

    public WS_CONTROL.getOperacionesFacturaResp getOperacionesFactura(WS_CONTROL.getOperacionesFacturaReq parametros, java.util.List<WS_CONTROL.TMS.entidades.Boleto> boletos);
