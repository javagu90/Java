...
public class ERClientesDireccionesTbl implements Serializable {
  ...
  /*  @Column(name = "ADICIONAL1")
    ...
    public ERClientesDireccionesTbl(BigDecimal clientesDireccionesId, String calle, String noExt, String codigoPostal, BigInteger creadoPor, Date fechaCreacion, BigInteger ultimaActualizacionPor, Date ultimaFechaActualizacion) {
        ...
        this.setTelefono(campos[2]!= null? campos[2]:"");
        this.setTelefonoCelular(campos[3]!= null? campos[3]:"");
        this.setTelefonoOficina(campos[4]!= null? campos[4]:"");
        this.setTelefonoFax(campos[5]!= null? campos[5]:"");
        this.setCalle(campos[6]!= null? campos[6]:"");
        this.setNoExt(campos[7]!= null? campos[7]:"");
        this.setNoInt(campos[8]!= null? campos[8]:"");
        this.setCodigoPostal(campos[9]!= null? campos[9]:"");
        this.setColonia(campos[10]!= null? campos[10]:"");
        this.setCiudad(campos[11]!= null? campos[11]:"");
        this.setEstado(campos[12]!= null? campos[12]:"");
        this.setPais(campos[13] != null? campos[13]:"");
