...
public class cssConsultas {
    ...
    public String[][] obtenerComponentes(){
        ...
        for(int i=0; i<componentes.size(); i++){
            ...
            System.out.println("Tipo "+componentes.get(i).getComponenteBusId()+"  Nombre  "+componentes.get(i).getNombreComponente()+" - "+componentes.get(i).getComponenteBusId());
//            System.out.println("Nombre  "+componentes.get(i).getNombreComponente());
