...
//datos iniciales y de boletaje boolean datosinicio;
    ...
    public void setEmpresasImpresora(Object[][] empresas) {
        ...
        for(i=0; i<this.empresasImpresora.length; i++)
            if(this.empresasImpresora[i][3].toString().equals("VOUCHERS") && this.empresasImpresora[i][0].toString().equals(getEmpresaPrincipal())){
                ...
                /*System.out.println("this.empresasImpresora["+i+"][0]"+this.empresasImpresora[i][0].toString());
                System.out.println("this.empresasImpresora["+i+"][1]"+this.empresasImpresora[i][1].toString());
                System.out.println("this.empresasImpresora["+i+"][2]"+this.empresasImpresora[i][2].toString());
                System.out.println("this.empresasImpresora["+i+"][3]"+this.empresasImpresora[i][3].toString());
                System.out.println("this.empresasImpresora["+i+"][4]"+this.empresasImpresora[i][4].toString());
                System.out.println("this.empresasImpresora["+i+"][5]"+this.empresasImpresora[i][5].toString());
                System.out.println("this.empresasImpresora["+i+"][6]"+this.empresasImpresora[i][6].toString());
                 *
                 */
    ...
    public void setDbgSetUrl(String a) {
        this.dbgSetUrl = a;
        //if(this.dbgSetUrl.contains("dev."))setBs_Company("0072");//0663 Cambio realizado por VAGL supervisado por IMM //setBs_Company("0072");
        if(this.dbgSetUrl.contains("dev3."))setBs_Company("0663");//0663 Cambio realizado por VAGL supervisado por IMM //setBs_Company("0072");
        //if(this.dbgSetUrl.contains("dev."))setBs_Company("0663");//Cambio realizado por VAGL supervisado por IMM //setBs_Company("0072");
