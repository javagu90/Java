...
import tmstrafico.AppPrincipal;
...
public class jlaypnl_login extends JLayeredPane {
    ...
    public jlaypnl_login(login_main p) {
        ...
        iniciarConexion();
        principal.setTitle("TMS Tráfico v2.9.3 "+ventaLoginCnx.getNombreTerminal()+" - Inicio de Sesión");
        System.out.println("Trafico Rev.21.11.14");
