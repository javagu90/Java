...
import subProcesos.JComponentCellEditor;
...
public class JIFVenta extends javax.swing.JInternalFrame {
    ...
    public JIFVenta(Vector datosIniciales) {
        String MENU_NOMBRE;
        long MENU_ID;
        long USUARIO_ID;
        ...
        labelER = new JLabel( "", new ImageIcon( this .getClass().getResource("/icon/ER.png") ),
                JLabel.CENTER);
        labelER.setBackground(Color.WHITE);
        labelADO = new JLabel( "", new ImageIcon( this.getClass().getResource("/icon/ADO.png") ),
                JLabel.CENTER);
        labelADO.setBackground(Color.WHITE);
        labelADOGL = new JLabel( "", new ImageIcon( this.getClass().getResource("/icon/ADOGL.png") ),
                JLabel.CENTER);
        labelADOGL.setBackground(Color.WHITE);
        labelAU = new JLabel( "", new ImageIcon( this.getClass().getResource("/icon/AU.png") ),
                JLabel.CENTER);
        labelAU.setBackground(Color.WHITE);
        inicioGral=false;
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jLabel7)
                    .add(jLabel6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jTxtTipoPasaje, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
                    .add(jTxtAsientos, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)))
        );
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .add(jPanel5Layout.createSequentialGroup()
                .add(jLblTarifaAdulto, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 62, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                ...
                .addContainerGap())
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jScpResumenVtaCorrida, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
        );
        ...
        jTblCorridas.setDefaultEditor( JComponent.class, new JComponentCellEditor() );
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .add(jScpCorridas, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 794, Short.MAX_VALUE)
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jScpCorridas, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 463, Short.MAX_VALUE)
        );
        ...
        jPnlCHorarioLayout.setHorizontalGroup(
            ...
            .add(jScpCH, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 794, Short.MAX_VALUE)
            .add(jScpBO, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 794, Short.MAX_VALUE)
        );
        ...
        jPnlVtaActualLayout.setHorizontalGroup(
            ...
            .add(jPnlVtaActualLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jtxt_personaAutorizada, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
                .add(14, 14, 14)
                .add(jLblTotalVtaActual, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
                .addContainerGap())
            ...
            .add(jScpVtaActual, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 794, Short.MAX_VALUE)
        );
        jPnlVtaActualLayout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPnlVtaActualLayout.createSequentialGroup()
                ...
                .add(jScpVtaActual, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 99, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jLblBarraEstado, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
        );
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(layout.createSequentialGroup()
                                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                    ...
                                    .add(org.jdesktop.layout.GroupLayout.LEADING, jPnlVtaActual, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .add(15, 15, 15))))
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(jPanel5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPnlRecoleccion, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
// TODO add your handling code here:
        this.sesionVenta.setEnterEnCorrida(false);
        System.out.println("Se seteo la variable EnterEnCorrida = false3");
...
// TODO add your handling code here:
    ...
    // TODO add your handling code here:
        ...
        switch(evt.getKeyCode()){
            case KeyEvent.VK_ESCAPE:
                int rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), null, "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                if(rSP!=0){
                    this.getToolkit().beep();
                    if(rSP!=-1){
            ...
            break;
            case KeyEvent.VK_F1:
                rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), null, "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                if(rSP!=0){
                    this.getToolkit().beep();
                    if(rSP!=-1){
                        DialogoAceptar.mostrarDialogo("TMS Venta","Asiento "+rSP+" bloqueado.", Color.RED);
            ...
            case KeyEvent.VK_ENTER: 
                ...
                if(ValidaTipoPasajero()){
                    ...
                    rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), sesionVenta.getCadenaTiposPasaje(), "A",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                    ...
                    if(rSP!=0){
                        ...
                        {
                            if(rSP==-5)
                                DialogoAceptar.mostrarDialogo("TMS Venta.", "Tipo de pasajero no disponible para esta corrida.",Color.RED);
                            else
                                DialogoAceptar.mostrarDialogo("TMS Venta.", "Registro ocupado.",Color.RED);
                        }
            ...
            case KeyEvent.VK_F12:
                //if(!sesionVenta.getUserCon().getAplicacionVenta()) return;
                if(!ValidaSesionVenta()) return;
                //if(this.listaCorridas[fila][12]==null || this.listaCorridas[fila][12].equals("") || this.listaCorridas[fila][12].equals("-1"))
                //{
...
// TODO add your handling code here:
        ...
        switch(evt.getKeyCode()){
            ...
            case KeyEvent.VK_ENTER:
                ...
                if(!sesionVenta.getUserCon().getFolioUnico() && sesionVenta.getUserCon().getAplicacionVenta()){
                ...
                if(fila<0){
                    this.getToolkit().beep();
                    DialogoAceptar.mostrarDialogo("¡Importante!","La corrida ya no esta abierta para venta.", Color.RED);
                    xCorridas.setDataVector(null, encCorridas);
                    AnchoColumnasCorridas();
                    jTxtFecha.setText(hoyEs);
                    jTxtHora.setText("");
                ...
                System.out.println("Convenio?: "+listaCorridas[fila][9]);
                if(listaCorridas[fila][9].toString().equals("S"))
                       TarifaServicio = Double.valueOf(listaCorridas[fila][10].toString());
                else
                ...
                int xa=0;
                System.out.println("listaCorridas["+fila+"][6]?: "+listaCorridas[fila][6]);
                System.out.println("Se seteo la variable EnterEnCorrida = true");
                this.sesionVenta.setEnterEnCorrida(true);
                strCorridaActualId = this.listaCorridas[fila][6].toString();
                jThdConsultaCorrida.setCorridaActualId(strCorridaActualId
                ,(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString())
                ,(this.listaCorridas[fila][4]==null  ?"" :this.listaCorridas[fila][4].toString())
                ,(this.listaCorridas[fila][3]==null  ?"" :this.listaCorridas[fila][3].toString())
                ,(this.listaCorridas[fila][1]==null  ?"" :this.listaCorridas[fila][1].toString())
                ,(this.listaCorridas[fila][2]==null  ?"" :this.listaCorridas[fila][2].toString())
                ,(this.listaCorridas[fila][4]==null  ?"" :this.listaCorridas[fila][4].toString())
                ,(this.listaCorridas[fila][11]==null  ?"" :this.listaCorridas[fila][11].toString()));
                System.out.println("this.corridaActual[63]: "+this.corridaActual[63].toString());
                int countWhile = 0;
               ...
               sesionVenta.setTiposPasajeLealtad(Integer.valueOf(this.listaCorridas[fila][8].toString()),jCboOrigen.getSelectedItem().toString());
                ...
                if((prom.toUpperCase().equals("DIRECTO ECONOMICO-CAPU-TAPO") || prom.toUpperCase().equals("DIRECTO ECONOMICO-TAPO-CAPU") || prom.toUpperCase().equals("PULLMAN PRIMERA CLASE-CAPU-TAPO") || prom.toUpperCase().equals("PULLMAN PRIMERA CLASE-TAPO-CAPU") || prom.toUpperCase().equals("PULLMAN PLUS-CAPU-TAPO") || prom.toUpperCase().equals("PULLMAN PLUS-TAPO-CAPU") || prom.toUpperCase().equals("PULLMAN PRIMERA CLASE-CAPU-NORTE") || prom.toUpperCase().equals("PULLMAN PRIMERA CLASE-NORTE-CAPU") || prom.toUpperCase().equals("DIRECTO ECONOMICO-SMA-TAPO") || prom.toUpperCase().equals("DIRECTO ECONOMICO-TAPO-SMA")  )  && (this.transaccion.equals(txCANJE_BA) || this.transaccion.equals(txCHORARIO)) && sesionVenta.getTmsVtaFacade().getPromocionVigente() )
                {
...
//                    if((sesionVenta.getUserCon().getServicioTarifaRedondo()/2)<=montoPromocionVA)
                    ...
                    if(sesionVenta.getAplicaPromocion(montoPromocionVA,sesionVenta.getUserCon().getServicioTarifaRedondo(),tDescuento,sesionVenta.getUserCon().getServicioTarifaSencillo()))
                    ...
                    else    
                    {
                        ...
                        if(this.transaccion.equals(txCANJE_BA))
                            DialogoAceptar.mostrarDialogo("TMS Venta.", "<html>Los boletos de promoción solo pueden ser canjeados<br> los Miércoles de Octubre.</html>", Color.RED);
                          //DialogoAceptar.mostrarDialogo("TMS Venta.", "<html>Los boletos de promoción solo pueden ser canjeados<br> los Miércoles de Mayo y Junio.</html>", Color.RED);
                        else
                            DialogoAceptar.mostrarDialogo("TMS Venta.", "<html>Los boletos de promoción solo se pueden cambiar de <br> horario los Miércoles de Octubre.</html>", Color.RED);
//                            DialogoAceptar.mostrarDialogo("TMS Venta.", "<html>Los boletos de promoción solo se pueden cambiar de <br> horario los Miércoles de Mayo y Junio.</html>", Color.RED);
//                        DialogoAceptar.mostrarDialogo("TMS Venta.", "Los boletos de promoción no se pueden cambiar de horario en esta corrida.", Color.RED);   
                ...
                System.out.println("Convenio?(jTblCorridas): "+listaCorridas[fila][9]);
                System.out.println("this.listaCorridas[fila][8](jTblCorridas)?: "+this.listaCorridas[fila][8]);
                // EN CASO DE CANJE O CAMBIO DE HORARIO, DISPONE DE TIPO PASAJE
                if((this.transaccion.equals(txCANJE_BA) || this.transaccion.equals(txCHORARIO)) && this.listaCorridas[fila][9].equals("N"))
                {
               ...
               // CHECA SI EL BOLETO ES SIN NUMERO DE ASIENTO
                if(sesionVenta.getUserCon().getSnAsiento()){
                 ...
                 //Se agrega la validacion de la tarifa para corrida de conven
                System.out.println("this.transaccion: "+this.transaccion);
                System.out.println("this.listaCorridas[fila][9]: "+this.listaCorridas[fila][9]);

                if((this.transaccion.equals(txCANJE_BA) || this.transaccion.equals(txCHORARIO)))
                {
                    double Tarifa = 0, tDescuento = 0;;
                    if(this.listaCorridas[fila][9].equals("S"))
                    {
                        System.out.println("Busca tarifa de: "+sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getTipoPasajero().toCharArray()[0]);
                        for(int k=0; k<sesionVenta.getPasajerosConvenio().size(); k++)
                        {
                           //System.out.println("    "+((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTipoPasaje()+".equals("+(sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getTipoPasajero().toCharArray()[0])+") ==> "+((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTarifaSencillo());
                           String tipoBoleto = ((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTipoPasaje();
                           String tipoCorrida = ""+sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getTipoPasajero().toCharArray()[0];
                           //if(((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTipoPasaje().equals((sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getTipoPasajero().toCharArray()[0])))
                           if(tipoBoleto.equals(tipoCorrida))
                               Tarifa = Double.valueOf("" + ((ClaseTiposPasajeConvenio) sesionVenta.getPasajerosConvenio().get(k)).getTarifaSencillo());
                        }
                    }
                    else
                    {
                        long tipoId;
                        System.out.println("Tipo PasajeroHO:"+ sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getTipoPasajero().toCharArray()[0]);
                        tipoId = jTxtTipoPasaje.getTipopasajeid(sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getTipoPasajero().toCharArray()[0],Long.valueOf(this.listaCorridas[fila][8].toString()));
                        System.out.println("jTxtTipoPasaje.getTipopasajeid("+sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getTipoPasajero().toCharArray()[0]+","+Long.valueOf(this.listaCorridas[fila][8].toString())+")");
                        System.out.println("Tipo PasajeroID: "+tipoId);
                        tDescuento = jTxtTipoPasaje.getDescuento(tipoId);
                        if(this.listaCorridas[fila][12]==null || this.listaCorridas[fila][12].equals("") || this.listaCorridas[fila][12].equals("-1"))
                            Tarifa = sesionVenta.getUserCon().getServicioTarifaSencillo()-(tDescuento*sesionVenta.getUserCon().getServicioTarifaSencillo());

                    }
                    System.out.println("Tarifa PasajeroHO(Enter):"+ Tarifa+" Contra "+sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getImporteBoleto());
                    if(Tarifa!=sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getImporteBoleto())
                    {
                        this.getToolkit().beep();
                ...
                jTxtAsientos.requestFocusInWindow();
                //this.sesionVenta.setEnterEnCorrida(false);
                //System.out.println("Se seteo la variable EnterEnCorrida = false1");
...
//		19
//        
                        if(( this.listaCorridas[fila][8].toString().equals("19") || this.listaCorridas[fila][8].toString().equals("20")  ||  this.listaCorridas[fila][8].toString().equals("225") || this.listaCorridas[fila][8].toString().equals("226") || this.listaCorridas[fila][8].toString().equals("241") || this.listaCorridas[fila][8].toString().equals("242") || this.listaCorridas[fila][8].toString().equals("219") || this.listaCorridas[fila][8].toString().equals("220") || this.listaCorridas[fila][8].toString().equals("292") || this.listaCorridas[fila][8].toString().equals("293") ) && sesionVenta.getTmsVtaFacade().getPromocionVigente() && xVtaActual.getValueAt(rowsel, 2).toString().equals("A") )
                             TTarifa = sesionVenta.getUserCon().getServicioTarifaRedondo()-(sesionVenta.getUserCon().getServicioTarifaRedondo()*.5);   
...
//                    jtxt_personaAutorizada.setText("");
                ...
                case KeyEvent.VK_ESCAPE:
                    ...
                    if(!sesionVenta.getUserCon().getSnAsiento() && !transaccion.equals(txCANJE_BA))
                        rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), sesionVenta.getCadenaTiposPasaje(), "P",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                    else{
                        if(!sesionVenta.getUserCon().getSnAsiento() && transaccion.equals(txCANJE_BA) && !(this.listaCorridas[fila][12]==null ?"-1" :this.listaCorridas[fila][12].toString()).equals("-1") ) 
                        {
                            String CadenaTiposPasaje = "";
                             for(int i=0; i<sesionVenta.getVariosTmsBoletosVentaTbl().size(); i++)
                                 CadenaTiposPasaje=CadenaTiposPasaje+","+sesionVenta.getVariosTmsBoletosVentaTbl().get(i).getTipoPasajero();
                             System.out.println("Entra al nuevo renglon... CadenaTiposPasaje: "+CadenaTiposPasaje);
                            rSP = sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), CadenaTiposPasaje, "P",(this.listaCorridas[fila][12] == null ? "" : this.listaCorridas[fila][12].toString()), (this.listaCorridas[fila][3] == null ? "" : this.listaCorridas[fila][3].toString()), (this.listaCorridas[fila][1] == null ? "" : this.listaCorridas[fila][1].toString()), (this.listaCorridas[fila][2] == null ? "" : this.listaCorridas[fila][2].toString()), false);
                        }
                        else
                        {
                            if(!sesionVenta.getUserCon().getSnAsiento() && transaccion.equals(txCANJE_BA))
                            {
                                System.out.println("Entra al viejo renglon...");
                                rSP = sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), null, "E", (this.listaCorridas[fila][12] == null ? "" : this.listaCorridas[fila][12].toString()), (this.listaCorridas[fila][3] == null ? "" : this.listaCorridas[fila][3].toString()), (this.listaCorridas[fila][1] == null ? "" : this.listaCorridas[fila][1].toString()), (this.listaCorridas[fila][2] == null ? "" : this.listaCorridas[fila][2].toString()), false);
                            }
                            else rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), sesionVenta.getCadenaTiposPasaje(), "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                        }
                    }
                    if(rSP!=0){
                        this.getToolkit().beep();
                ...
                case KeyEvent.VK_F1: 
                    ...
                    if(transaccion.equals(this.txCHORARIO))
                      rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), sesionVenta.getCadenaTiposPasaje(), "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),true);
                    else
                     rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), sesionVenta.getCadenaTiposPasaje(), "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                    if(rSP==-1){
                        this.getToolkit().beep();
    ...
    // TODO add your handling code here:d
        ...
        switch(evt.getKeyCode()){
            case KeyEvent.VK_ESCAPE:
                System.out.println("Convenio?(jTxtAsientos): "+listaCorridas[fila][9]);
                System.out.println("this.listaCorridas[fila][8](jTxtAsientos)?: "+this.listaCorridas[fila][8]);
                System.out.println("sesionVenta.isTransaccionConvenio(): "+sesionVenta.isTransaccionConvenio());
                // EN CASO DE CANJE O CAMBIO DE HORARIO, DISPONE DE TIPO PASAJE
                if((this.transaccion.equals(txCANJE_BA) || this.transaccion.equals(txCHORARIO)) && this.listaCorridas[fila][9].equals("N"))
                //if((this.transaccion.equals(txCANJE_BA) || this.transaccion.equals(txCHORARIO)) && !sesionVenta.isTransaccionConvenio())
                {
                    int r=-1;
                    while(r==-1){
            ...
            case KeyEvent.VK_ENTER:
                ...
                if(!ValAsientos(sesionVenta.getCapacidadPlantilla(plantillaId)) || BoletoAVender.size()==0){
                    ...
                    if(this.listaCorridas[fila][12]==null || this.listaCorridas[fila][12].equals("") || this.listaCorridas[fila][12].equals("-1"))
                        rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), null, "I",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                    else
                    {
                        if( transaccion.equals(txCHORARIO) || transaccion.equals(txCANJE_BA))
                         {
                            String CadenaTiposPasaje = "";
                             for(i=0; i<sesionVenta.getVariosTmsBoletosVentaTbl().size(); i++)
                                 CadenaTiposPasaje=CadenaTiposPasaje+","+sesionVenta.getVariosTmsBoletosVentaTbl().get(i).getTipoPasajero();
                            rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), CadenaTiposPasaje, "I",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),true);                        
                         }
                        else
                            rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), null, "I",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                    }
                    ...
                    System.out.println("SP_Ocup(jTxtAsientosKeyPressed) "+rSP);
                    if(rSP!=0){
                        this.getToolkit().beep();
                       /* if(rSP!=-1){
...
// TODO add your handling code here:
        switch(evt.getKeyCode()){
            ...
            case KeyEvent.VK_RIGHT: case KeyEvent.VK_DOWN:
                ubiCrit = uCtServicio;
                jCboServicio.requestFocusInWindow(); break;
...
// TODO add your handling code here:
        switch(evt.getKeyCode()){
            ...
            case KeyEvent.VK_LEFT: case KeyEvent.VK_UP: //System.out.println("VALOR DBLINK "+sesionVenta.getDBLink());
                if(!AutoCompletaFecha()) return; ubiCrit = uCtDestino; jCboDestino.requestFocusInWindow(); break;
...
//                case 5: column.setPreferredWidth(Math.round(anchoContenedor*(float)0.14)); break;                
                ...
                case 2: column.setPreferredWidth(Math.round(anchoContenedor*(float)0.07)); break;
                case 3: column.setPreferredWidth(Math.round(anchoContenedor*(float)0.26)); break;
                case 4: column.setPreferredWidth(Math.round(anchoContenedor*(float)0.1)); break;
                case 5: column.setPreferredWidth(Math.round(anchoContenedor*(float)0.1)); break;
...
//                case 7: column.setPreferredWidth(Math.round(anchoContenedor*(float)0.09)); break;
    ...
    private void EjecutaConsulta(){
     try {
        ...
        ambienteBoletosRedondos=false;
        //sesionVenta.setBoletoACConvenio(false);
        ...
        jTblCorridas.setDefaultRenderer( JComponent.class, new JComponentCellRenderer() );
        jTblCorridas.setDefaultEditor( JComponent.class, new JComponentCellEditor() );
        
        for(int i = 0; i<this.listaCorridas.length; i++)
        {
            String conv = this.listaCorridas[i][9].toString();
            String empresa = this.listaCorridas[i][7].toString();
            if(conv.equals("N"))
               jTblCorridas.setValueAt( labelER, i, 6 );
            else
            {
                jTblCorridas.setValueAt(labelADO, i, 6);
                if(empresa.equals("ADO GL"))
                    jTblCorridas.setValueAt(labelADOGL, i, 6);
                if(empresa.equals("Autobuses Unidos"))
                    jTblCorridas.setValueAt(labelAU, i, 6);
            }
        }
        ...
        if(this.transaccion.equals(txCHORARIO)||this.transaccion.equals(txCANJE_BA)){
            ...
            if(sesionVenta.getUserCon().getServicioTarifaSencillo()!=tarifaAdultoCHBA && !sesionVenta.isTransaccionConvenio() ){
                this.getToolkit().beep();
                DialogoAceptar.mostrarDialogo("Cambio de horario o Canje de Boleto.","<html>No es posible cambiar el boleto para<br>este destino y servicio.</html>", Color.RED);
                xCorridas.setDataVector(null,encCorridas);
                AnchoColumnasCorridas();
...
//                jCboDestino.requestFocusInWindow();
            ...
            System.out.println("Dentro de HO sesionVenta.isTransaccionConvenio(): "+sesionVenta.isTransaccionConvenio());
            if(sesionVenta.isTransaccionConvenio())
            {
                ...
                {
                    Tarifa = sesionVenta.getUserCon().getServicioTarifaSencillo()-(tDescuento*sesionVenta.getUserCon().getServicioTarifaSencillo());
                    System.out.println("Tarifa PasajeroHO:"+ Tarifa+" Contra "+sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getImporteBoleto());
                    if(Tarifa!=sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getImporteBoleto())
                    {
                        this.getToolkit().beep();
                        DialogoAceptar.mostrarDialogo("Cambio de horario o Canje de Boleto.","<html>No es posible cambiar el boleto para<br>este destino y servicio.</html>", Color.RED);
...
//        Boletos = new Object[BoletoAVender.size()][31];
        Boletos = new Object[BoletoAVender.size()][37];//[32]
...
//                +this.listaCorridas[fila][19].toString()+","
            ...
            if(listaCorridas[fila][12]==null || listaCorridas[fila][12].toString().equals("") || listaCorridas[fila][12].toString().equals("-1"))
                Boletos[i][0] = this.listaCorridas[fila][0].toString().substring(0,10)+"-"+this.listaCorridas[fila][1];  // corrida-hora
            else
                Boletos[i][0] = this.listaCorridas[fila][0].toString()+this.listaCorridas[fila][2].toString()+"-"+this.listaCorridas[fila][1];  // corrida-hora
            ...
            if(( this.listaCorridas[fila][8].toString().equals("19") || this.listaCorridas[fila][8].toString().equals("20")  ||  this.listaCorridas[fila][8].toString().equals("225") || this.listaCorridas[fila][8].toString().equals("226") || this.listaCorridas[fila][8].toString().equals("241") || this.listaCorridas[fila][8].toString().equals("242") || this.listaCorridas[fila][8].toString().equals("219") || this.listaCorridas[fila][8].toString().equals("220") || this.listaCorridas[fila][8].toString().equals("292") || this.listaCorridas[fila][8].toString().equals("293") ) && normal.equals("R") && sesionVenta.getTmsVtaFacade().getPromocionVigente() && (""+tipoPasajero).equals("A") )
            {
                if(redondeo.equals("S"))
                    TTarifa = Math.ceil(Tarifa-(Tarifa*.5));
                else
                {
                    TTarifa = Tarifa-(Tarifa*.5);
            ...
            //System.out.println("para buscar tarifa la transaccionID es: "+listaCorridas[fila][12]);
            //System.out.println("tipoPasajero: "+tipoPasajero);
            //System.out.println("sesionVenta.getPasajerosConvenio(): "+sesionVenta.getPasajerosConvenio().size());
            if(listaCorridas[fila][12]==null || listaCorridas[fila][12].toString().equals("") ||listaCorridas[fila][12].toString().equals("-1"))
                TTarifa = TTarifa;
            else
            {
                    for(int k=0; k<sesionVenta.getPasajerosConvenio().size(); k++)
                    {
                       if(((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTipoPasaje().equals((""+tipoPasajero)))
                       {
                           if(normal.equals("S"))
                                TTarifa = Double.valueOf(""+((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTarifaSencillo());
                           else
                               TTarifa = Double.valueOf(""+((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTarifaRedondo());
                       }
                    }
                
            }
            System.out.println("la tarifa es: "+TTarifa);
            suma = suma+TTarifa;
            ...
            Boletos[i][31] = normal;                                                    //Identifica al boleto de la parte sencillo del redondo
            //Boletos[i][31] = "S";
            if(listaCorridas[fila][12]==null || listaCorridas[fila][12].toString().equals("") ||listaCorridas[fila][12].toString().equals("-1"))
                Boletos[i][35] = "N"; 
            else
                Boletos[i][35] = "S";                                                    //Indica si es boleto de una corrida de convenio
...
//        Boletos = new Object[sesionVenta.getVariosTmsBoletosVentaTbl().size()][31];
        Boletos = new Object[sesionVenta.getVariosTmsBoletosVentaTbl().size()][37];//[32]
...
//        Boletos = new Object[sesionVenta.getVariosTmsBoletosVentaTbl().size()][31];
        ...
        for(int i=0; i<sesionVenta.getVariosTmsBoletosVentaTbl().size(); i++){
            if(listaCorridas[fila][12]==null || listaCorridas[fila][12].toString().equals("") || listaCorridas[fila][12].toString().equals("-1"))
                ...
                Boletos[i][0] = this.listaCorridas[fila][0]+"-"+this.listaCorridas[fila][1]+" "+this.listaCorridas[fila][2];  // corrida-hora
            Boletos[i][1] = BoletoAVender.get(i).toString();                           // asiento
    ...
    private int EjecutaReservacion(){
        ...
        if(r==3){
            int rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), sesionVenta.getCadenaTiposPasaje(), "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
            if(rSP==-1){
                this.getToolkit().beep();
                DialogoAceptar.mostrarDialogo("TMS Venta.", "Registro ocupado.",Color.RED);
                return -1;
    ...
    private void EjecutaCobro(){
        ...
        String  transaccionConvenioId = this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString();
        if(this.transaccion.equals(txVENTA_BA))
            transaccionConvenioId = "";
        System.out.println("Antes de cobrar manda de la corrida("+this.listaCorridas[fila][0]+") para convenio el transaccionId("+this.transaccion+"): "+transaccionConvenioId);
        System.out.println("    fila: "+fila);

        jDlgCobro = new JDlgCobro(Boletos, sesionVenta, "", this.transaccion, this.nombreEmpresa, this.BoletosRedondos, jlbl_reloj,transaccionConvenioId,(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()));
    ...
    public void setLabelFolio(String strFolio, String Empresa) {
      if(sesionVenta.getUserCon().getAplicacionVenta())  
      {
            ...
            if(f1>f2){
                ...
                if(strFolio.equals("0")) jLblFolioActual.setText("<html>Folio Actual: <font color="+ColoresInterfaz.cHTML1+">-</font></html>");
    ...
    private void CancelarBoleto(){
        ...
        if(this.transaccion.equals(txVENTA)){
            ...
            this.sesionVenta.setSoloConvenio(false);
            if(sesionVenta.getUserCon().getAplicacionVenta()) jLblBarraEstado.setText(mensajes.getMensajeVta(1));
            else jLblBarraEstado.setText(mensajes.getMensajeCallCenter(1));
            jTxtFecha.setText(hoyEs);
            jTxtHora.setText("");
...
//            System.out.println("Datos para verificar encBO[0][6]: "+encBO[0][6].toString());
    ...
    public boolean CambioHorario(){
        ...
        /*
                for(int i=0; i<jTblBO.getRowCount(); i++)
                {
                    float monto1;
                    float monto2;
                    for(int j=0; j<jTblCH.getRowCount(); i++)
                    {
                      if(jTblBO.getValueAt(i,3).toString().equals(jTblCH.getValueAt(j,3).toString()))
                      {
                           monto1 = Float.valueOf(jTblBO.getValueAt(i,7).toString());
                           monto2 = Float.valueOf(jTblCH.getValueAt(j,7).toString());
                           if(monto1!=monto2)
                           {
                           }
                      }
...
//            System.out.println("****** Despues de _RegistroVentaSP ...."+sesionVenta.getTmsVtaFacade()._ObtieneFechaHoraBD2());
          ...
          //////////// Realiza el cambio de Horario de convenio ////////////////////
                    String trans = this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString();
                    System.out.println("getAdicional12()(Convenio) : "+sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getAdicional12().equals("S"));
                    System.out.println("trans : "+trans);
                   if(sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getAdicional12().equals("S") && (!trans.equals("") && !trans.equals("-1")))
                   {
                     if(!sesionVenta.cambioHorarioConvenio(Boletos,(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()))) 
                     {
...
///////////////////////////////////////////  
                    ...
                    trans = this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString();
                    //HO ER-ADO
                    
                    if(!sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getAdicional12().equals("S") && (!trans.equals("") && !trans.equals("-1")) )
                    {
                        System.out.println("Entro a HOC_ER_ADO...");
                        for(int i=0;i<Boletos.length;i++) Boletos[i][13] = "10";
                    }   
                    //HO ADO-ER
                    if(sesionVenta.getVariosTmsBoletosVentaTbl().get(0).getAdicional12().equals("S") && (trans.equals("") || trans.equals("-1")) )
                    {
                        System.out.println("Entro a HOC_ADO_ER...");
                        //se cancela el boleto de ADO con motivo 10
                        if(!sesionVenta.CancelaBoletoMultiple("10","",true)){
                   ...
                   res1=sesionVenta._RegistroVentaSP(Boletos,(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()));
                    for(int k=0; k<sesionVenta.getFoliosBoletos().size(); k++)
                    {
                        Vector v = (Vector)sesionVenta.getFoliosBoletos().get(k);
                        //private Object[][] Boletos;
                        for(int l=0; l<Boletos.length; l++)
                        {
                            ...
                            {
                                Boletos[l][19]=v.get(1).toString();
                                Boletos[l][36]=v.get(2).toString();
                                break;
                            }
                        }
                    }            
            System.out.println("****** Despues de _RegistroVentaSP.... res: "+res1+"   "+sesionVenta.getTmsVtaFacade()._ObtieneFechaHoraBD2());
            if(res1==0){
                    ...
                    if(insertaLealtad && res1==0){
                        ...
                        {//String boleto_id,String folio_preimpreso, String preoducto, String ciudad_venta,String tipo_operacion,String num_tarjeta,String numero_operacion, String usuario, String contraseña, String importe, String tipo_pasajero, String caja, String unidad_negocio, String descuento
                            ...
                            try { // Call Web Service Operations
                                ...
                                System.out.println("Result(getOperacion(A)(HO)("+numeroOperacion+")) = "+result.getStatus().isSuccess());
...
//////////////////////
                System.out.println("Antes de liberrar asiento cancelado: "+listaCorridas[fila][12]);
                 System.out.println("fila: "+fila);
                 System.out.println("this.sesionVenta.isSoloConvenio(): "+this.sesionVenta.isSoloConvenio());
                 System.out.println("this.sesionVenta.isTransaccionConvenio(): "+this.sesionVenta.isTransaccionConvenio());
                //if((listaCorridas[fila][12]==null || listaCorridas[fila][12].toString().equals("") || listaCorridas[fila][12].toString().equals("-1") ) && !this.sesionVenta.isSoloConvenio())
                if(!this.sesionVenta.isTransaccionConvenio())
                {
                    sesionVenta.iTempos=0;
                    int rSP=-1;
                    while(rSP==-1){
...
//        AnchoColumnasVtaActual2();
    ...
    public boolean CanjeBA(){
        ...
        if(res){
            ...
            if(sesionVenta.isBoletoACConvenio())
            {
                
                String transId = (this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString());
                if(transId.equals("") || transId.equals("-1"))
                {
                    System.out.println("entra a realizar el canje de convenio ACC_ADO_ER...");
                    respuesta = sesionVenta.ACC_ADO_ER();
                }
                else
                {
                    System.out.println("entra a realizar el canje de convenio ACC_ADO_ADO...");
                    respuesta = sesionVenta.ACC_ADO_ADO(Boletos,(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()));
                }
                System.out.println("respuesta(ACC_ADO_ADO): "+respuesta);
                sesionVenta.setSoloConvenio(true);
                if(respuesta.indexOf("nada")>=0)
                {
                    System.out.println("BA - desocupar (_OcuparAsientosSP)"+this.corridaId+" - "+sesionVenta.getCadenaAsientos()+" - "+sesionVenta.getCadenaTiposPasaje());
                    sesionVenta.iTempos=0;
                    int rSP=-1;
                    while(rSP==-1){
                        rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), sesionVenta.getCadenaTiposPasaje(), "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                    ...
                    this.getToolkit().beep();
                    DialogoAceptar.mostrarDialogo("TMS Venta.", "No fue posible realizar el canje de boleto de convenio.",Color.RED);
                    continua = false;
                }                
            }
            if(continua)
            {
                ...
                String r = "";
                for(int y=0; y<rsp.length;y++)
                    r = r + ","+rsp[y];
                sesionVenta.setFoliosConvenioHO(r);
                System.out.println("Ciudad Origen en canje de boleto abierto: "+sesionVenta.strCiudadOrigen);
                int res1=sesionVenta._RegistroVentaSP(Boletos,(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()));
                System.out.println("res1: "+res1);
                    System.out.println("Folios(CanjeBA()): "+sesionVenta.getFoliosBoletos());
                    for(int k=0; k<sesionVenta.getFoliosBoletos().size(); k++)
                    {
                        Vector v = (Vector)sesionVenta.getFoliosBoletos().get(k);
                        //private Object[][] Boletos;
                        System.out.println("Folios("+k+"): "+v);
                        for(int m=0; m<Boletos.length; m++)
                        {
                            System.out.println("Compara: ("+v.get(0).toString()+").equals("+Boletos[m][1]+")");
                            if(v.get(0).toString().equals(Boletos[m][1].toString()))
                            {
                                System.out.println("entr aa guardar en [19]: "+v.get(1).toString());
                                System.out.println("entr aa guardar en [36]: "+v.get(2).toString());
                                Boletos[m][19]=v.get(1).toString();
                                Boletos[m][36]=v.get(2).toString();
                                break;
                            }
                        }
                    }            
             if(res1==0){
               ...
               ImprimeBoletos x = new ImprimeBoletos();
                ...
                if(!result){
                    ...
                    if(this.transaccionAux.equals(txCANJE_BA_RF))
                    {
                         ticket = new imprimir_ticket_canjeBA_ref(sesionVenta.getNombreAutorizado(), sesionVenta.getReferenciaCanjeBA(), "",sesionVenta.getUserCon().getCajaNumero(), sesionVenta.getUserCon().getUsuarioNum(), sesionVenta.getUserCon().getUsuarioNom(),Boletos, ids,"Boleto Abierto");
                         ticket.ImprimeDatos(salidaImpresionTVRef);
                    }
                    Boletos=null;
                    jLblTotalVtaActual.setText("Total: $0.00");
                    if(this.transaccionAux.equals(txCANJE_BA_RF))
    ...
    private void CanjeBoletoAbierto(){ 
        ...
        if(this.transaccion.equals(txVENTA)){
            ...
            tarifaAdultoCHBA=sesionVenta.getTarifaTramo1(sesionVenta.getTmsBoletosVentaTbl().getServicio()+
                            ...
                            "SEN",0);
            jLblBarraEstado.setText(mensajes.getMensajeVta(19));
            sesionVenta.setBoletoACConvenio(jIFCanjeBA.isBoletoConvenio());
            sesionVenta.setFoliosAbiertos(jIFCanjeBA.getFoliosAbiertos());
...
//                    }
                   // EjecutaCobro();
                    ...
                    if(res1 == 0)
                    {
                       ...
                       imprimir_ticket_canjeBA_ref ticket = null; 
                         ticket = new imprimir_ticket_canjeBA_ref(sesionVenta.getNombreAutorizado(), sesionVenta.getReferenciaCanjeBA(), "",sesionVenta.getUserCon().getCajaNumero(), sesionVenta.getUserCon().getUsuarioNum(), sesionVenta.getUserCon().getUsuarioNom(),Boletos, ids, tpoCnkg);
                         ticket.ImprimeDatos(salidaImpresionTVRef);
                       DialogoAceptar.mostrarDialogo("Boletos canjeados.", "<html>Los boletos referenciados han sido canjeados<br> Tome el comprobante del canje</html>", colorDialogoActivo);                       
                       ...
                       this.jLblTx.setText("*VENTA*");
                        ...
                        jTxtFecha.setText(hoyEs);
                        jTxtHora.setText("");
                        this.sesionVenta.setTransaccionConvenio(false);
                        abledComponentsCriterios();
                        abledComponents(jTblCorridas);
                        desHabilitarCriterios(1);
                        jTxtFecha.selectAll();
    ...
    private void ResumenDefault(){
        ...
        SwingUtilities.invokeLater(new Runnable(){
            public void run(){
                ...
                sesionVenta.setObjResumenVtaCorrida(objResumenVtaCorrida);
                sesionVenta.setEncResumenVtaCorrida(encResumenVtaCorrida);
    ...
    private int eligeAsientoInsertaTipo(){
        ...
        int rSP=sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), null, "I",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
        System.out.println("SP_Ocup(eligeAsientoInsertaTipo) "+rSP);
        if(rSP!=0){
            this.getToolkit().beep();
            if(rSP!=-1){
    ...
    private boolean consultarCorridaActual(boolean esPrimeraVez) throws ConsultaCorridaException{
        try{
            ...
            //System.out.println("jThdConsultaCorrida.getCorridaActual: "+v);
            if(v == null){
                if(sesionVenta.isCorridaCerrada()) return false;
                return true;
            }
            System.out.println("Llenando this.corridaActual...");
...
//        Object[][] nuevo = new Object[Boletos.length*2][31];
        Object[][] nuevo = new Object[Boletos.length*2][37];//[32]
        int i;
        ...
        for(i=0; i<Boletos.length; i++){
            ...
            tDescuento = jTxtTipoPasaje.getDescuento(tipoId);
            String redondeo =jTxtTipoPasaje.getRedondeo(tipoId);
                //------------------- OBTIENE LA TARIFA CONVENIO 
                    if(listaCorridas[fila][12]==null || listaCorridas[fila][12].toString().equals("") ||listaCorridas[fila][12].toString().equals("-1"))
                       System.out.println("Tarifa normal...");
                    else
                    {
                       System.out.println("Tarifa Convenio...");
                            for(int k=0; k<sesionVenta.getPasajerosConvenio().size(); k++)
                            {
                               if(((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTipoPasaje().equals((""+tipoPasajero)))
                                       sesionVenta.getUserCon().setServicioTarifaRedondo(Double.valueOf(""+((ClaseTiposPasajeConvenio)sesionVenta.getPasajerosConvenio().get(k)).getTarifaRedondo()));
                            }
            ...
            for(pasa=0; pasa<36; pasa++){//32
                if(pasa==6)
                    ...
                    if(pasa==5)
                    {
                        ...
                        if(( this.listaCorridas[fila][8].toString().equals("19") || this.listaCorridas[fila][8].toString().equals("20") || this.listaCorridas[fila][8].toString().equals("225") || this.listaCorridas[fila][8].toString().equals("226")  || this.listaCorridas[fila][8].toString().equals("241") || this.listaCorridas[fila][8].toString().equals("242") || this.listaCorridas[fila][8].toString().equals("219") || this.listaCorridas[fila][8].toString().equals("220") || this.listaCorridas[fila][8].toString().equals("292") || this.listaCorridas[fila][8].toString().equals("293")) && sesionVenta.getTmsVtaFacade().getPromocionVigente() && Boletos[i][6].toString().equals("R") && (""+tipoPasajero).equals("A"))                
                        {
                            if(redondeo.equals("S"))
                                ...
                                nuevo[contRedondos][5]= Math.ceil(sesionVenta.getUserCon().getServicioTarifaRedondo()-(sesionVenta.getUserCon().getServicioTarifaRedondo()*.5));
                            else
                            {
                                ...
                                double tar = (sesionVenta.getUserCon().getServicioTarifaRedondo()-(sesionVenta.getUserCon().getServicioTarifaRedondo()*.5));
                                if(redondeo.equals("S"))
                                    tar= Math.ceil(tar);
                                else
                                {
                                ...
                                nuevo[contRedondos][5]= tar;//sesionVenta.getUserCon().getServicioTarifaRedondo()-(sesionVenta.getUserCon().getServicioTarifaRedondo()*.5);
            ...
            if(Boletos[i][6].toString().equals("R")){ // construyo boleto redondo
                ...
                System.out.println("calcTarifa(R): "+calcTarifa);
//                calcTarifa = sesionVenta.getUserCon().getServicioTarifaRedondo()-sesionVenta.getUserCon().getServicioTarifaSencillo();
                
                String prom = Boletos[i][8]+"-"+Boletos[i][21]+"-"+Boletos[i][22];
//                if(Boletos[i][8].toString().equals("DIRECTO ECONOMICO") || Boletos[i][8].toString().equals("PULLMAN PRIMERA CLASE"))
                   //if((prom.toUpperCase().equals("DIRECTO ECONOMICO-CAPU-TAPO") || prom.toUpperCase().equals("DIRECTO ECONOMICO-TAPO-CAPU") || prom.toUpperCase().equals("PULLMAN PRIMERA CLASE-CAPU-TAPO") || prom.toUpperCase().equals("PULLMAN PRIMERA CLASE-TAPO-CAPU")) && sesionVenta.getTmsVtaFacade().getPromocionVigente())
                if(( this.listaCorridas[fila][8].toString().equals("19") || this.listaCorridas[fila][8].toString().equals("20") || this.listaCorridas[fila][8].toString().equals("225") || this.listaCorridas[fila][8].toString().equals("226")  || this.listaCorridas[fila][8].toString().equals("241") || this.listaCorridas[fila][8].toString().equals("242") || this.listaCorridas[fila][8].toString().equals("219") || this.listaCorridas[fila][8].toString().equals("220") || this.listaCorridas[fila][8].toString().equals("292") || this.listaCorridas[fila][8].toString().equals("293")) && sesionVenta.getTmsVtaFacade().getPromocionVigente() && Boletos[i][2].toString().equals("A"))                                
                {
...
//                    nuevo[contRedondos-1][5] = sesionVenta.getUserCon().getServicioTarifaRedondo()/2;
    ...
    //                    nuevo[contRedondos][5] = Math.ceil(calcTarifa -(tDescuento*calcTarifa));    // importe boleto
                        System.out.println("calcTarifa2(R): "+calcTarifa);
                   ...
                   {
                        nuevo[contRedondos][5] = calcTarifa;    // importe boleto
                        nuevo[contRedondos-1][5] = calcTarifa;
                    }
...
//                System.out.println(" nuevo["+contRedondos+"-1][5](importe boleto): "+Boletos[i][5]);
                ...
                if(Boletos[i][35].equals("S"))
                    nuevo[contRedondos][7] = "Estrella Roja";                          // empresa 
                else
                ...
                nuevo[contRedondos][35] = Boletos[i][35];                        //Indica si es boleto de una corrida de convenio
                contRedondos++;
            }
        }
...
//        BoletosRedondos = new Object[contRedondos][31];
        ...
        BoletosRedondos = new Object[contRedondos][37];//[32]
        //double suma = 0; 
    ...
    private void deshacer(){
        ...
        if(this.ubiCompo==ucVtaActual){
            ...
            if(this.ubiCompo==ucTipoPasaje){
                ...
                rSP=-1;
                while(rSP==-1){
                    sesionVenta._OcuparAsientosSP(this.corridaId, sesionVenta.getCadenaAsientos(), null, "E",(this.listaCorridas[fila][12]==null ?"" :this.listaCorridas[fila][12].toString()),(this.listaCorridas[fila][3]==null ?"" :this.listaCorridas[fila][3].toString()),(this.listaCorridas[fila][1]==null ?"" :this.listaCorridas[fila][1].toString()),(this.listaCorridas[fila][2]==null ?"" :this.listaCorridas[fila][2].toString()),false);
                    if(rSP==-1){
                        sesionVenta.iTempos++;
                        if(sesionVenta.iTempos>sesionVenta.tTempos){
                            System.out.println("Asiento bloqueado");
    ...
    private boolean existeCorridaRegreso(){
        ...
        int zz = -1;
        if(this.listaCorridas[fila][12]==null || this.listaCorridas[fila][12].equals("") || this.listaCorridas[fila][12].equals("-1"))
            zz = sesionVenta.busqExisteCorrida(o, o, d, criterio.getHoy(), s, this.nombreEmpresa);
        else
            zz = sesionVenta.busqExisteCorrida(o, o, d, criterio.getHoy(), s, "Estrella Roja");
        switch(zz){
    ...
    private boolean consultaListadoCorridas() throws ConsultaCorridaException{
        ...
        if(dc!=null)
            System.out.println(dc[0][0]+"<==>"+dc[0][1]+"<==>"+dc[0][2]+"<==>"+dc[0][3]+"<==>"+dc[0][4]+"<==>"+dc[0 ][5]+"<==>"+dc[0][6]+"<==>"+dc[0][7]+"<==>"+dc[0][8]+"<==>"+dc[0][9]+"<==>"+dc[0][10]+"<==>"+dc[0][11]+"<==>"+dc[0][12]);//+"<==>"+dc[0][1]+"<==>"+
       boolean buscaCorridasConvenio = false;
       Object[][] cc = new Object[0][0];
       if(criterio.getDestino().equals("%"))
       {
           buscaCorridasConvenio = false;
           System.out.println("No busca Corridas Convenio....");
       }
       else
       {
         if(this.sesionVenta.isVenderConvenio())
         {
               buscaCorridasConvenio = true;
               String caja = "ER";
               String marca = "ADO";
               String serv = criterio.getServicio();
               if(criterio.getServicio().equals("%"))
               {
                   serv="";
                   marca = "";
               }
               ...
               {
                   if(criterio.getServicio().equals("PULLMAN PRIMERA CLASE"))
                   {
                       marca = "ADO";
                       serv = "P";
                   }
                   ...
                   {
                       if(criterio.getServicio().equals("PULLMAN PLUS"))
                       {
                           marca = "ADOGL";
                           serv = "L";
                       }
                       ...
                       {
                           if(criterio.getServicio().equals("DIRECTO ECONOMICO"))
                           {
                               marca = "AU";
                               serv = "S";
                           }
                ...
                System.out.println("****** Valida si busca corridas de convenio *****");
                System.out.println("xDate: "+xDate);
                System.out.println("criterio.gettHoy(): "+new Date(criterio.getHoy().getTime()));
                System.out.println("buscaRutaConvenio("+criterio.getOrigen()+","+criterio.getDestino()+","+serv+","+marca+")");
                int rutaIdConvenio = sesionVenta.buscaRutaConvenio(criterio.getOrigen(),criterio.getDestino(),serv,marca);
                System.out.println("RutaIdConvenio: "+rutaIdConvenio);
                if(getmilis(formatoDate.format(new Date(criterio.getHoy().getTime())),"00:00") > getmilis(formatoDate.format(xDate),"00:00") && rutaIdConvenio!=-2)
                  buscaCorridasConvenio = true;
                else
                  buscaCorridasConvenio = false;
               String fecha= formatoDateServer.format(criterio.getHoy()).substring(0,10);
               if(buscaCorridasConvenio)
               {
                   System.out.println("Si busca Corridas Convenio con: \n "+"   Origen: "+criterio.getOrigen()+"   Destino:"+criterio.getDestino()+"   Caja: "+caja+"   marca:"+marca+"   Servicio:"+serv+"   fecha:"+fecha+"  HoraDesde: "+jTxtHora.getText());
                   formatoDateServer.format(criterio.getHoy()).substring(0,10);
                   cc= sesionVenta.consultaCorridasConvenio(caja,marca,serv,criterio.getOrigen(),fecha,criterio.getDestino(),jTxtHora.getText());
                   if(cc.length==0)
                       buscaCorridasConvenio = false;
               }
           }
       ...
       if(dc==null){
        ...
        if(buscaCorridasConvenio)
        {
            this.listaCorridas = new Object[dc.length+cc.length][14];
            System.out.println("dc.length = "+dc.length);
            System.out.println("cc.length = "+cc.length);
            for(int i=0; i<dc.length;i++)
            {
                this.listaCorridas[i][0] = dc[i][0];this.listaCorridas[i][1] = dc[i][1];this.listaCorridas[i][2] = dc[i][2];
                this.listaCorridas[i][3] = dc[i][3];this.listaCorridas[i][4] = dc[i][4];this.listaCorridas[i][5] = dc[i][5];
                this.listaCorridas[i][6] = dc[i][6];this.listaCorridas[i][7] = dc[i][7];this.listaCorridas[i][8] = dc[i][8];
                this.listaCorridas[i][9] = dc[i][9];this.listaCorridas[i][10] = dc[i][10];this.listaCorridas[i][11] = dc[i][11];
                this.listaCorridas[i][12] = dc[i][12];
                this.listaCorridas[i][13] = getmilis(dc[i][1].toString(),dc[i][2].toString());
                //System.out.println("Corrida: "+ this.listaCorridas[i][0]+" Fecha: "+new Date(getmilis(dc[i][1].toString(),dc[i][2].toString())));
            }
            int i= dc.length;
            for(int j=0; j<cc.length;j++)
            {
                this.listaCorridas[i][0] = cc[j][0];this.listaCorridas[i][1] = cc[j][1];this.listaCorridas[i][2] = cc[j][2];
                this.listaCorridas[i][3] = cc[j][3];this.listaCorridas[i][4] = cc[j][4];this.listaCorridas[i][5] = cc[j][5];
                this.listaCorridas[i][6] = cc[j][6];this.listaCorridas[i][7] = cc[j][7];this.listaCorridas[i][8] = cc[j][8];
                this.listaCorridas[i][9] = cc[j][9];this.listaCorridas[i][10] = cc[j][10];this.listaCorridas[i][11] = cc[j][11];
                this.listaCorridas[i][12] = cc[j][12];
                this.listaCorridas[i][13] = getmilis(cc[j][1].toString(),cc[j][2].toString());
                //System.out.println("Corrida: "+ this.listaCorridas[i][0]+" Fecha: "+new Date(getmilis(cc[j][1].toString(),cc[j][2].toString())));
                i++;
            }
            System.out.println("Inicia ordenamiento..."+new Date());
            this.listaCorridas = ordenaListaCorridas(this.listaCorridas);
            System.out.println("Termina ordenamiento..."+new Date());
        }
        else
            this.listaCorridas = dc;
       if(dc!=null)
        System.out.println(this.listaCorridas[0][0]+"<==>"+this.listaCorridas[0][1]+"<==>"+this.listaCorridas[0][2]+"<==>"+this.listaCorridas[0][3]+"<==>"+this.listaCorridas[0][4]+"<==>"+this.listaCorridas[0 ][5]+"<==>"+this.listaCorridas[0][6]+"<==>"+this.listaCorridas[0][7]+"<==>"+this.listaCorridas[0][8]+"<==>"+this.listaCorridas[0][9]+"<==>"+this.listaCorridas[0][10]+"<==>"+this.listaCorridas[0][11]+"<==>"+this.listaCorridas[0][12]);//+"<==>"+dc[0][1]+"<==>"+
        this.strCorridaActualId=this.listaCorridas[0][6].toString();
        //System.out.println("consultaListadoCorridas(Convenio?): "+this.listaCorridas[0][9].toString()+" ==> "+this.listaCorridas[0][12].toString());
        jThdConsultaCorrida = new JThdConsultaCorrida(sesionVenta, this.strCorridaActualId
                ,(this.listaCorridas[0][12]==null ?"" :this.listaCorridas[0][12].toString())
                ,(this.listaCorridas[0][4]==null  ?"" :this.listaCorridas[0][4].toString())
                ,(this.listaCorridas[0][3]==null  ?"" :this.listaCorridas[0][3].toString())
                ,(this.listaCorridas[0][1]==null  ?"" :this.listaCorridas[0][1].toString())
                ,(this.listaCorridas[0][2]==null  ?"" :this.listaCorridas[0][2].toString())
                ,(this.listaCorridas[0][4]==null  ?"" :this.listaCorridas[0][4].toString())
                ,(this.listaCorridas[0][11]==null  ?"" :this.listaCorridas[0][11].toString())
                );
    ...
    private long getmilis(String fecha, String hora)
    {
        String[] fech = fecha.split("/");
        Timestamp date = null;
        date = date.valueOf(fech[2]+"-"+fech[1]+"-"+fech[0]+" "+hora+":00");
        return date.getTime();
    }

    private Object[][] ordenaListaCorridas(Object[][] lista)
    {
       Object[] tmp =  new Object[14];
         for (int i = 0; i < lista.length; i++)
         {
           ...
           {
                long n1 = Long.valueOf(lista[j][13].toString());
                long n2 = Long.valueOf(lista[j + 1][13].toString());
                //System.out.println("n1 > n2 :"+n1+" > " + n2);
                 if (n1 > n2)
                 {
                      //intercambiar(lista, j, j+1);
                       tmp[0] = lista[j][0]; tmp[1] = lista[j][1]; tmp[2] = lista[j][2]; tmp[3] = lista[j][3];
                       tmp[4] = lista[j][4]; tmp[5] = lista[j][5];  tmp[6] = lista[j][6]; tmp[7] = lista[j][7];
                       tmp[8] = lista[j][8]; tmp[9] = lista[j][9];  tmp[10] = lista[j][10]; tmp[11] = lista[j][11];
                       tmp[12] = lista[j][12]; tmp[13] = lista[j][13];
                       lista[j][0] = lista[j + 1][0]; lista[j][1] = lista[j + 1][1]; lista[j][2] = lista[j + 1][2];
                       lista[j][3] = lista[j + 1][3]; lista[j][4] = lista[j + 1][4]; lista[j][5] = lista[j + 1][5];
                       lista[j][6] = lista[j + 1][6]; lista[j][7] = lista[j + 1][7]; lista[j][8] = lista[j + 1][8];
                       lista[j][9] = lista[j + 1][9]; lista[j][10] = lista[j + 1][10]; lista[j][11] = lista[j + 1][11];
                       lista[j][12] = lista[j + 1][12]; lista[j][13] = lista[j + 1][13];
                       lista[j + 1][0] = tmp[0]; lista[j + 1][1] = tmp[1]; lista[j + 1][2] = tmp[2];
                       lista[j + 1][3] = tmp[3]; lista[j + 1][4] = tmp[4]; lista[j + 1][5] = tmp[5];
                       lista[j + 1][6] = tmp[6]; lista[j + 1][7] = tmp[7]; lista[j + 1][8] = tmp[8];
                       lista[j + 1][9] = tmp[9]; lista[j + 1][10] = tmp[10]; lista[j + 1][11] = tmp[11];
                       lista[j + 1][12] = tmp[12]; lista[j + 1][13] = tmp[13];
                  }
               }
           }
                    ...
                    if((ubiCompo == ucAsientos || ubiCompo == ucListCorridas ||
                        ...
                        try{
                            ...
                            if(vAsientosX!=null){
                                ...
                                sa=sh;
                                System.out.println("En el hilo(Plantilla) isEnterEnCorrida(): "+sesionVenta.isEnterEnCorrida());
                                if(sesionVenta.isEnterEnCorrida() && !sesionVenta.getUserCon().getSnAsiento())
                                {
                                    selecAsientosAnticipado();
                                    sesionVenta.setEnterEnCorrida(false);
                                }
    ...
    public void selecAsientosAnticipado(){
                int countWhile = 0;
               System.out.println("+++++++++++ Entra al selecAsientosAnticipado ++++++++++++++");
                if(!ValidaSesionVenta()) return;
                if(sesionVenta.getUserCon().getAplicacionVenta())
                if(!sesionVenta.getUserCon().getFolioUnico() && sesionVenta.getUserCon().getAplicacionVenta()){
                    long f1=Long.valueOf(sesionVenta.obtenerFolioActual(this.nombreEmpresa)), f2=sesionVenta.obtenerFolioFinal(this.nombreEmpresa);
...
//                        DialogoAceptar.mostrarDialogo("TMS Venta.", "Los boletos de promoción no se pueden cambiar de horario en esta corrida.", Color.RED);
                ...
                //DialogoAceptar.mostrarDialogo("TMS Venta.", "Tipo de pasajero(s) no disponible.", Color.RED);
                System.out.println("Convenio?(selecAsientosAnticipado): "+listaCorridas[fila][9]);
                System.out.println("this.listaCorridas[fila][8](selecAsientosAnticipado)?: "+this.listaCorridas[fila][8]);
                // EN CASO DE CANJE O CAMBIO DE HORARIO, DISPONE DE TIPO PASAJE
                if((this.transaccion.equals(txCANJE_BA) || this.transaccion.equals(txCHORARIO)) && this.listaCorridas[fila][9].equals("N"))
                {
                    int r, i; vTP=new Vector();
               ...
               // CHECA SI EL BOLETO ES SIN NUMERO DE ASIENTO
                ...
                jTxtAsientos.requestFocusInWindow();
                //this.sesionVenta.setEnterEnCorrida(false);
                //System.out.println("Se seteo la variable EnterEnCorrida = false2");
                System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                enabledComponents(jTblCorridas);
    }
    ...
    private int fila=0;
//    private Object[] encCorridas = {"Corrida", "Fecha", "Hora", "Servicio", "Origen", "Destino","","","","Convenio"};
    private Object[] encCorridas = {"Corrida", "Fecha", "Hora", "Servicio", "Origen", "Destino","Convenio"};
    ...
    private javax.swing.JLabel labelADO;
    private javax.swing.JLabel labelADOGL;
    private javax.swing.JLabel labelAU;
