 ...
 *
 * Clase para conjuntar los resultados obtenidos de getCambioHorario del WebService y que seron procesadas por EJB
 */
 ...
 * @author opalafox
 */
public class CambioHorarioResp extends ExchangeResp implements Serializable{
