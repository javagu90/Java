 ...
 *
 * Ejecución de métodos Facade de bean(s) asociados
 * en todos los casos se hace uso de @Interceptors dedicados a la validacíón
 * de los datos que son provistos, tanto requeridos como opcionales para mantener
 * el código separado de la lógica del negocio
 */
    ...
    public CorridasResp getCorridas(CorridasReq corridasReq)throws Exception{
        ...
        try {
           ...
           stmt = (OracleCallableStatement) cnx.prepareCall(q1);
            ...
            ((OraclePreparedStatement)stmt).setString(2, "AMPERSA");//corridasReq.getEmpresa()); //VAGL 03/01/2012
 ...
 **/
    ...
    public VenderBoletosResp getVenderBoletos(VenderBoletosReq venderBoletosReq)throws Exception{
        ...
        try {
            ...
            ((OraclePreparedStatement)stmt).setInt(1, venderBoletosReq.getSesionId());
            ...
            /* Recuperación del arreglo de boletos que es devuelto por el procedimiento
             * se hace la recuperación del Arreglo obtenido como parámetro de salida y se transforma en un ResultSet
             ...
             * obtención de los atributos obtenidos del objeto de la segunda columna del ResultSet
             *
             * Por último se hace la traducción del Vector a un Array para cumplir con los requisitos de la clase a ser 
    ...
    public CancelarBoletosResp getCancelarBoletos(CancelarBoletosReq cancelarBoletosReq)throws Exception{
        ...
        try {
            ...
            ((OraclePreparedStatement)stmt).setArray(2, arrayFoliosBoletos);
            ((OraclePreparedStatement)stmt).setString(3, cancelarBoletosReq.getMotivoCancelación());
        ...
        */
        ...
        for (int i = 0; i < noCorridas; i++){
            ...
            if (singleCorrida.length != 39){
                throw new Exception("No se puede generar una corrida debido a número de argumentos incorrectos");
            }
