...
public class ErClientesTbl implements Serializable {
    ...
    private List<ERClientesDireccionesTbl> direcciones = new ArrayList<ERClientesDireccionesTbl>();

    private List<ErClientesDirFiscalesTbl> direccionesFiscales = new ArrayList<ErClientesDirFiscalesTbl>();
...
*/
    ...
    public ErClientesTbl(BigDecimal clienteId, String nombre, String personaMoral, String activo, String aplicaRetencion, BigDecimal saldoActual, BigDecimal saldoFavor, Date fechaRegistro, BigInteger creadoPor, Date fechaCreacion, BigInteger ultimaActualizacionPor, Date ultimaFechaActualizacion) {
     ...
     public ErClientesTbl(String[] campos) {
        ...
        this.setFactuarcionAutomatica(campos[43]);
        this.setIdSocioIntimo(campos[44]);
        this.setTipoPago(campos[45]);
...
*/
     ...
     */
    public List<ErClientesDirFiscalesTbl> getDireccionesFiscales() {
     ...
     */
    public void setDireccionesFiscales(List<ErClientesDirFiscalesTbl> direccionesFiscales) {
