 ...
 * @author  vgonzalez
 */
public class jdlg_error extends javax.swing.JDialog {
    
    /**
     * Creates new form jdlg_error
     */
    public jdlg_error(String texto1, String texto2, String titulo){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\NetBeansProyects\\TMSRecaudacion\\TMSRecaudacion-app-client\\src\\java\\tmsrecaudacion\\images\\error.gif"));
    ...
    private void jlbl_mensaje1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jlbl_mensaje1KeyReleased
      if(evt.getKeyCode() == evt.VK_ENTER)
          this.dispose();
    }//GEN-LAST:event_jlbl_mensaje1KeyReleased
