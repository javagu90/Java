...
public class JDlgCobro extends javax.swing.JDialog {
    ...
    private Object[][] FormasPago=null;
        private Object[] encFormasPago = {"Forma de Pago", "Clave", "Total a Cobrar", "Recibo", "Referencia", "Autorizacion","SOCIO"};
    ...
    public JDlgCobro(Object[][] pBoletos, SesionVenta pSesionVenta, String pDoctoRvn,
                               String pTransaccion, String pNombreEmpresa, Object[][] pBoletosRedondos, RelojVisualVta pThX, String ptransaccionId, String pfechaCorrida, String phoraCorrida) {
        this.thX = pThX;
...
//            System.out.println("Lealtad("+listado.get(i).getRutaId()+")"+listado.get(i).getLealtad() +" Lunes: "+listado.get(i).getL_LUNES() +" Tipo: "+listado.get(i).getAplicaTipoLealtad()+" Aplica ("+listado.get(i).getLetraTipo()+") = "+listado.get(i).getAplicaLealtad());
    ...
    public JDlgCobro(Object[][] pBoletos,
                               ...
                               String pTransaccion, String pNombreEmpresa, RelojVisualVta pThX, String ptransaccionId, String pfechaCorrida, String phoraCorrida) {
        this.thX = pThX;
        this.nombreEmpresa=pNombreEmpresa;
        this.transaccion=pTransaccion;
        this.Boletos = pBoletos;
...
//            System.out.println("Lealtad("+listado.get(i).getRutaId()+")"+listado.get(i).getLealtad() +" Lunes: "+listado.get(i).getL_LUNES() +" Tipo: "+listado.get(i).getAplicaTipoLealtad()+" Aplica ("+listado.get(i).getLetraTipo()+") = "+listado.get(i).getAplicaLealtad());
    ...
    private void AnchoColumnasFormasPago(){
        ...
        for (int i = 0; i < 7; i++) {
            ...
            switch(i){
                //"Forma de Pago", "Clave", "Total a Cobrar", "Recibo", "Referencia", "Autorizacion"
                ...
                case 6: column.setPreferredWidth(0);
            ...
            switch (e.getKeyCode()){
                ...
                case KeyEvent.VK_DOWN:
                    ...
                    case KeyEvent.VK_ENTER:
                        ...
                        System.out.println(" Boletos[0][35] KeyEvent.VK_ENTER = "+ Boletos[0][35]);
                        if(Boletos[0][11]!=null && Boletos[0][35].equals("N")){
                            ...
                            if(!sesionVenta.existeCorrida(Boletos[0][11].toString(), liga)){
                                ...
                                this.setVentaOk(1);
                                this.dispose();
                                System.out.println("Imposible vender boleto ...KeyEvent.VK_ENTER");
                                DialogoAceptar.mostrarDialogo("¡Imposible vender boleto!","La corrida no existe.",Color.RED);
                                return;
                            }
                        }
    ...
    private void jTblTipoPagos_keyPressed(KeyEvent e) {
        ...
        if (rowsize > 0) {
            switch (e.getKeyCode()){
                case KeyEvent.VK_F7:
                    if(xFormasPago.getValueAt(rowsel,1).toString().equals("AMX")) jDlgCupones.setColNoEditable(-1);
...
//                    }
//                    ////////////
                    System.out.println(" Boletos[0][35] KeyEvent.VK_F10 = "+ Boletos[0][35]);
                    if(Boletos[0][11]!=null  && Boletos[0][35].equals("N")){
                        String liga = (sesionVenta.getTipoTransaccion().equals("R") ? sesionVenta.getDBLink() : "");
                        if(!sesionVenta.existeCorrida(Boletos[0][11].toString(), liga)){
                            this.getToolkit().beep();
                            ...
                            this.setVentaOk(1);
                            this.dispose();
                            System.out.println("Imposible vender boleto ...KeyEvent.VK_F10");
                            DialogoAceptar.mostrarDialogo("¡Imposible vender boleto!","La corrida no existe.",Color.RED);
                            return;
                        }
                    }
                    ...
                    if(rowsel == filaBancomer){
                        if(Boletos[0][11]!=null){
                            ...
                            if(!sesionVenta.existeCorrida(Boletos[0][11].toString(), liga)){
                                ...
                                this.dispose();
                                System.out.println("Imposible vender boleto ...filaBancomer");
                                DialogoAceptar.mostrarDialogo("¡Imposible vender boleto!","La corrida no existe.",Color.RED);
                                return;
                            }
                        }
                ...
                case KeyEvent.VK_F12:
                    ...
                    System.out.println(" Boletos[0][35] KeyEvent.VK_F12 = "+ Boletos[0][35]);
                    if(Boletos[0][11]!=null){
                        String liga = (sesionVenta.getTipoTransaccion().equals("R") ? sesionVenta.getDBLink() : "");
                        if(!sesionVenta.existeCorrida(Boletos[0][11].toString(), liga)){
                            this.getToolkit().beep();
                            ...
                            sesionVenta.detenerWS();
                            this.dispose();
                            System.out.println("Imposible vender boleto ...KeyEvent.VK_F12");
                            DialogoAceptar.mostrarDialogo("¡Imposible vender boleto!","La corrida no existe.",Color.RED);
                            return;
                        }
                    }
                    ...
                    System.out.println(formatoDebugFecha.format(new Date())+":"+"3.- Despues de checar VJS");
                    if(rowsel == filaBancomer){
                        System.out.println(" Boletos[0][35] filaBancomer = "+ Boletos[0][35]);
                        if(Boletos[0][11]!=null){
                            String liga = (sesionVenta.getTipoTransaccion().equals("R") ? sesionVenta.getDBLink() : "");
                            if(!sesionVenta.existeCorrida(Boletos[0][11].toString(), liga)){
                                this.getToolkit().beep();
    ...
    private void ejecutaVentaTJT(int indice){
    ...
    //                        acumula.validarMostrar();
            ...
            int edo=sesionVenta._RegistroVentaSP(Boletos,  this.transaccionId,  this.fechaCorrida,  this.horaCorrida);
                    System.out.println("Folios: "+sesionVenta.getFoliosBoletos());
                    for(int k=0; k<sesionVenta.getFoliosBoletos().size(); k++)
                    {
                        ...
                        for(int m=0; m<Boletos.length; m++)
                        {
                            ...
                            if(v.get(0).toString().equals(Boletos[m][1]))
                            {
            ...
            //Manda a registrar la Acumulacion de estrellas
               ...
               if(imprime)
               {
                ...
                if(!x.ImprimeDatos(xFormasPago.getValueAt(indice,1).toString(),
                    ...
                    Boletos,this.transaccion, sesionVenta.getUserCon().getDiasValBab(),sesionVenta.getUserCon().getUsuarioNom(), sesionVenta, thX.getFecha(),sesionVenta.getTmsVtaFacade().getPromocionVigente() ) ){
           ...
           if(!sesionVenta.getVtaRef().trim().equals("|") || sesionVenta.getVtaRef().length()>4)
           {
                    ...
                    if(this.sesionVenta.getUserCon().getAplicacionVenta())
                    {
                        ...
                        if(ticket.ImprimeDatos(salidaImpresionTVRef))
                        {
                            if(refRed.equals(""))
    ...
    private void EjecutaVenta(){
        ...
        if(Resta==0){
            ...
            if(!xFormasPago.getValueAt(this.jTblTipoPagos.getSelectedRow(),1).toString().equals("EFE")){// && xFormasPago.getValueAt(this.jTblTipoPagos.getSelectedRow(),1).toString().equals("SOC")){
                if(!this.transaccionId.equals("") && !this.transaccionId.equals("-1"))
                {
                    DialogoAceptar.mostrarDialogo("TMS Venta.","<html>No es posible realizar la compra con esta forma de pago. <br>Intente con otra forma de pago.</html>", Color.RED);
                    return;
                }
                               ...
                               sesionVenta.setBoletosLealtad(Boletos);
                                for(int k=0;k<insertadosRed.size(); k++)
                                {
                                    ...
                                    try { // Call Web Service Operation
                                        ...
                                        //result.getStatus().isSuccess();
                                        System.out.println("Inicia llamado getOperacion(R)... "+new Date());
                    ...
                    if(edo!=0){
                        ...
                        switch(edo){
                            ...
                            case -2: DialogoAceptar.mostrarDialogo("TMS Venta.","<html>No es posible terminar venta.<br>Corrida ya fue despachada.</html>", Color.RED);
                                     break;
                            case -3: break;
                            case -4: DialogoAceptar.mostrarDialogo("TMS Venta.","<html>No es posible terminar la venta de convenio.<br>Intente nuevamente.</html>", Color.RED);
                                     break;
                            default: DialogoAceptar.mostrarDialogo("TMS Venta.","<html>No es posible terminar venta.<br>Contacte al administrador del sistema.</html>", Color.RED);
                                     break;
                        }
               ...
               if(imprime)
               {
                   ...
                   System.out.println("Folio Actual: "+Long.valueOf(sesionVenta.obtenerFolioActual(this.nombreEmpresa)));
                        if(!x.ImprimeDatos(xFormasPago.getValueAt(this.jTblTipoPagos.getSelectedRow(),1).toString(),
                            ...
                            sesionVenta, thX.getFecha(),sesionVenta.getTmsVtaFacade().getPromocionVigente())){
                            if(FormasPago[indice][1].toString().equals("EFE")){
                                sesionVenta.EFECTIVO_CAJA+=Double.valueOf(this.jTxtTotalVenta.getText().replace("$"," ").replace(",",""));
                            }
                            this.setVentaOk(0);
                            this.getToolkit().beep();
                            DialogoAceptar.mostrarDialogo("¡Venta registrada!","Boleto no impreso por falla de impresion.", Color.RED);
...
//        }f
        ...
        try{sesionVenta.TextOut.close();} catch (IOException ex) {ex.printStackTrace();}            
        JDlgSysCboStandr x = new JDlgSysCboStandr(btx, sesionVenta, "", salidaImpresion, "", "", false, this.thX);
        x.setVisible(true);
        //if(!this.sesionVenta.getUserCon().getAplicacionVenta())
          //  x.ventaMoto_F5();
        //x.setModal(true);
        ...
        if(x.getSuccess()) 
        {
            ...
            this.aprobacion = z.getRspAuth()+";"+z.getRspOperationNumber()+";"+x.getReference();
            ...
            if(valorlectura.indexOf("%")>=0 && valorlectura.indexOf("&")>=0 && valorlectura.indexOf("_")>=0 && valorlectura.length()>20){
                ...
                if(resultado.substring(resultado.length()-1).equals("0") && resultado.length()>25){
                    if(resultado.substring(16,18).equals("00")){
                        ...
                        ejecutaVentaTJT(this.jTblTipoPagos.getSelectedRow());
                        if(!sesionVenta.AuditarFuncion()){
                            this.getToolkit().beep();
                            DialogoAceptar.mostrarDialogo("¡Error al tratar de auditar la funcion Cobro Tarjeta de Credito!", "<html>Presione <font color="+ColoresInterfaz.cHTML3+">ENTER</font> para continuar<br>con el proceso de venta.<html>.",Color.RED);
                        }
