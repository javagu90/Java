...
public class JdlgMessage extends javax.swing.JDialog {
     ...
     */
    public JdlgMessage(int message_type, String texto1, String texto2, String titulo){
        ...
        jlbl_barraEstado.setHorizontalAlignment( JTextField.LEADING );
        int nletras = 0;
        ...
        this.setSize((nletras * 6) + 90,126);
            ...
            this.getRootPane().setWindowDecorationStyle(message_type);
  ...
  private void initComponents() {
    ...
    jlbl_barraEstado.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    ...
    layout.setHorizontalGroup(
      ...
      .add(jlbl_barraEstado, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 744, Short.MAX_VALUE)
