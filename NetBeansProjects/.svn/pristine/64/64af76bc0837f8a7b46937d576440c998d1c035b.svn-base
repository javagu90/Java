 ...
 *
 * Clase para conjuntar los resultados obtenidos de getVenderBoletos del WebService y que serán procesadas por EJB
 */
 ...
 * @author opalafox
 */
public class VenderBoletosResp extends ExchangeResp{
