    ...
    public AsientosDispResp getAsientosDisp(AsientosDispReq asientosDispReq)throws Exception{
        ...
        try {
            cnx = dataSource.getConnection();
                   String q1 =
                    "BEGIN "+
                      "XER_TMSWS_PKG.TMSWS_GETASIENTOSDISP_ebus_PRC(?, ?, ?,  ?,?,?,?,?,?,?,?); " +
                      "COMMIT; " +
                      "EXCEPTION " +
                      "WHEN OTHERS THEN " +
                      "ROLLBACK; " +
    ...
    public VenderBoletosResp getVenderBoletos(VenderBoletosReq venderBoletosReq)throws Exception{
        ...
        try {
            cnx = dataSource.getConnection();
                   String q1 =
                    "BEGIN "+
                      "XER_TMSWS_PKG.tmsws_getVenderBoletosEBus_prc(?, ?,  ?,?,?,?,?,?); " +
                      "COMMIT; " +
                      "EXCEPTION " +
                      "WHEN OTHERS THEN " +
                      "ROLLBACK; " +
            ...
            ((OraclePreparedStatement)stmt).setLong(4, venderBoletosReq.getTransaccion().getNumeroTransaccion());
    ...
    public long getTipoPago(String ptipoPago)throws Exception{
        ...
        try {
            cnx = dataSource.getConnection();
                   String q1 =
                    "BEGIN "+
                      "XER_TMSWS_PKG.TMSWS_GETTIPOPAGO_PRC(?, ?, ?,  ?,?); " +
                      "COMMIT; " +
                      "EXCEPTION " +
                      "WHEN OTHERS THEN " +
                      "ROLLBACK; " +
    ...
    public TiposPagoResp getTiposPago()throws Exception{
        ...
        try {
            cnx = dataSource.getConnection();
                   String q1 =
                    "BEGIN "+
                      "XER_TMSWS_PKG.TMSWS_GET_TIPOS_PAGO_PRC(?, ?, ?,  ?); " +
                      "COMMIT; " +
                      "EXCEPTION " +
                      "WHEN OTHERS THEN " +
                      "ROLLBACK; " +
    ...
    public TerminalesResp getTerminales()throws Exception{
        ...
        try {
            cnx = dataSource.getConnection();
                   String q1 =
                    "BEGIN "+
                      "XER_TMSWS_PKG.TMSWS_GET_TERMINALES_PRC(?, ?, ?,  ?); " +
                      "COMMIT; " +
                      "EXCEPTION " +
                      "WHEN OTHERS THEN " +
                      "ROLLBACK; " +
    ...
    public ServiciosVtaResp getServciosVta()throws Exception{
        ...
        try {
            cnx = dataSource.getConnection();
                   String q1 =
                    "BEGIN "+
                      "XER_TMSWS_PKG.TMSWS_GET_SERVICIOS_PRC(?, ?, ?,  ?); " +
                      "COMMIT; " +
                      "EXCEPTION " +
                      "WHEN OTHERS THEN " +
                      "ROLLBACK; " +
    ...
    public EmpresasVtaResp getEmpresas()throws Exception{
        ...
        try {
            cnx = dataSource.getConnection();
                   String q1 =
                    "BEGIN "+
                      "XER_TMSWS_PKG.TMSWS_GET_EMPRESAS_PRC(?, ?, ?,  ?); " +
                      "COMMIT; " +
                      "EXCEPTION " +
                      "WHEN OTHERS THEN " +
                      "ROLLBACK; " +
