...
public class ErClientesDirFiscalesTbl implements Serializable {
    ...
    @Column(name = "DIR_FIS_DEFAULT")
    private String direccionFiscalPredeterminada="";
    ...
    public ErClientesDirFiscalesTbl(BigDecimal clientesDirFiscalesId, BigInteger creadoPor, Date fechaCreacion, BigInteger ultimaActualizacionPor, Date ultimaFechaActualizacion) {
        ...
        this.setEmail(campos.get(16) != null? campos.get(16).toString():"");
        this.setDireccionFiscalPredeterminada(campos.get(17) != null? campos.get(17).toString():"N");
         }
    ...
    /**
     * @return the direccionFiscalPredeterminada
     */
    public String getDireccionFiscalPredeterminada() {
        return direccionFiscalPredeterminada;
    }

    /**
     * @param direccionFiscalPredeterminada the direccionFiscalPredeterminada to set
     */
    public void setDireccionFiscalPredeterminada(String direccionFiscalPredeterminada) {
        this.direccionFiscalPredeterminada = direccionFiscalPredeterminada;
    }
