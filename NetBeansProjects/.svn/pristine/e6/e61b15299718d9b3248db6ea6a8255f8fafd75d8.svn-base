...
public class EntityDataModel<T> extends AbstractTableModel implements TableModel, Iterable<T> {
     ...
     * @param meta
     */
    public EntityDataModel(Class<T> cls, List<T> data) {
        super();
        this.data = data;
        ...
        Field field = fs[i];
        if(field.getAnnotation(javax.persistence.Column.class)!=null && (field.getAnnotation(javax.persistence.Id.class)==null))
    ...
    private void populate(Class<T> cls, Field attr) {
        columnNames.add(attr.getName());
        columnClasses.add(wrap(attr.getType()));
     ...
     */
    public Field getAttribute(int columnIndex) {
    ...
    public String getColumnName(int columnIndex) {
        return toTitleCase(splitCamelCase(columnNames.get(columnIndex)));
    }
