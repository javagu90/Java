    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(jtxt_numTarjeta, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 163, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
...
//        this.jPnlContenedorCentral.requestFocusInWindow();
    ...
    public void procesoManual(boolean moto){
            ...
            if(moto)
            {
                    if(!(jtxt_numTarjeta.getText().trim().length() == 10))
                    {
