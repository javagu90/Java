...
public class JDlgBProgreso extends javax.swing.JDialog {
    ...
    public JDlgBProgreso(JObsBProgreso pModelo, final JDlgSysCboStandr met) {
        this.setModal(false);
        initComponents();
        interfazColor();
        centrarJDialog();
                 ...
                 SwingUtilities.invokeLater(new Runnable(){
                     public void run(){
                         ...
                         if(met.isRespondio())
                         {
                             ...
                             new JDlgAceptar().mostrarDialogo("TMS Venta.", "Tiempo de espera agotado.",Color.RED);
                         }
    ...
    private void initComponents() {
        ...
        jlbl_mensaje.setText("Realizando Transacci\u00f3n con el Banco, favor de no presionar ninguna tecla.");
