...
import xer_emv_dll.JDlgBProgresoLealtadHO;
 ...
 * @author  vgonzalez
 */
public class JDlgAcumulaEstrellasHO extends javax.swing.JDialog {
    ...
    private JDlgBProgresoLealtadHO jProgreso = null;
    ...
    public JDlgAcumulaEstrellasHO(javax.swing.JDialog parent, boolean modal, Object[][] pboletos, SesionVenta psesionVenta,List<TmsTiposPasajeroTbl> plistado, boolean pmuestra, String pnumeroTarjeta) {
        super(parent, modal);
             ...
             for(int j=0; j<listado.size(); j++)
             {
                if(Boletos[i][2].toString().equals(listado.get(j).getLetraTipo()))
                {
                    ...
                    if(listado.get(j).getAplicaLealtad().equals("S"))
                    {
                        ...
                        System.out.println("Topo Pago(AcumlacionHO) = "+Boletos[i][13]);       
                        if(sesionVenta.getTiposPagoLealtad().indexOf(Boletos[i][13].toString())>=0)
                        { 
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                .add(jtxt_numTarjeta, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(jtxt_deslizarTarjeta, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE))
        );
    ...
    private void jtbl_boletosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbl_boletosKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_F1 && sesionVenta.getUserCon().getAplicacionVenta()){
            ...
            else
            {
                ...
                jProgreso = new JDlgBProgresoLealtadHO(new JObsBProgreso(0, 1000),this);
...
//        this.jPnlContenedorCentral.requestFocusInWindow();
    ...
    public void procesoManual(boolean moto){
            ...
            if(moto)
            {
                ...
                System.out.println("numTar(HO): "+numTar);
                    if(!(numTar.trim().length() == 10))
                    {
