...
public class JDlgRedimir extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(176, 20));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .add(jtxt_numTarjeta, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jtxt_deslizarTarjeta, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jLblBarraEstado, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 524, Short.MAX_VALUE)
    ...
    private void jtxt_numTarjetaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxt_numTarjetaKeyPressed
        if(evt.getKeyCode() == 10)
        {
            ...
            if(jtxt_numTarjeta.getText().trim().length() < 7)
            {
                ...
                System.out.println("numTar: "+jtxt_numTarjeta.getText().trim());
       ...
       if(evt.getKeyCode() == 10)
        {
            ...
            registros = new Vector();
            System.out.println("numTar: "+jtxt_deslizarTarjeta.getText().trim());
            if(!(jtxt_deslizarTarjeta.getText().trim().length() == 10))
            {
                JDlgAceptar DialogoAceptar = new JDlgAceptar();
                DialogoAceptar.mostrarDialogo("TMS Venta.", "Deslize una Tarjeta de Socio Intimo Válida.", Color.RED);
                jtxt_deslizarTarjeta.setText("");
...
//                String producto = (new StringBuilder()).append(sesionVenta.getEmpresaId(Boletos[i][7].toString())).append("").append(sesionVenta.getServicioId(Boletos[i][8].toString())).append("").append(sesionVenta.getTerminalLealtadId(Boletos[i][21].toString())).append("").append(sesionVenta.getTerminalLealtadId(Boletos[i][22].toString())).append("").append(tipoId).toString();
                ...
                vec.add(Integer.valueOf(i));
                vec.add(producto);
                vec.add(jtxt_deslizarTarjeta.getText().trim());
                vec.add(referencia);
                String unidad = "";
                if(Boletos[i][7].equals("Terminal Las Torres Puebla") || Boletos[i][7].equals("Autobuses Unidos"))
                    unidad = "TP";
                ...
                vec.add(unidad);
                registros.add(vec);
                setTarjeta(jtxt_deslizarTarjeta.getText().trim());
            }
