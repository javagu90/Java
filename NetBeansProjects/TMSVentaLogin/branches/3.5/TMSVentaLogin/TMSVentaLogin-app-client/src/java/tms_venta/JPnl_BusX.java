...
import plantilla.JCanvasPlantilla;
import plantilla.cssConsultas;
import plantilla.drawAsiento;
...
public class JPnl_BusX extends JPanel {
    ...
    private JCanvasPlantilla jcnvBusPlantilla;
    private GridBagLayout gridBagLayout1 = new GridBagLayout();
    private cssConsultas busVirtual;
    ...
    public JPnl_BusX(List<TmsComponenteBusTbl> acomponentes, TmsAutobusPlantillasEncTbl aencabezado, List<TmsAutobusPlantLineasTbl> alineas, Color pcPISO, Color pcASIENTO) {
        try {
            jcnvBusPlantilla = new JCanvasPlantilla(pcPISO, pcASIENTO);
            busVirtual = new cssConsultas();
    ...
    private void jbInit() throws Exception {
        ...
        int resta = (int)(xDn.getHeight()*142)/600;
        this.setMinimumSize(new Dimension(190,(int) (xDn.getHeight()-resta)));
        this.setSize(new Dimension(190,(int) (xDn.getHeight()-resta)));
    ...
    public void getPlantillaDefault() {
        ...
        jcnvBusPlantilla.setVectorAsientos(busVirtual.OCUPADO, null);
        jcnvBusPlantilla.setVectorAsientos(busVirtual.RESERVADO, null);
        jcnvBusPlantilla.setVectorAsientos(busVirtual.RESERVADONC, null);
        this.repaint();
    }
    ...
    public void setVND(Vector vnd){ jcnvBusPlantilla.setVND(vnd); }
    // DEFAULT PLANTILLA
    public void pintaPlantilla(long plantillaId) {
        ...
        jcnvBusPlantilla.setDatos(busVirtual.getPlantilla(), 
                                  ...
                                  busVirtual.getAnchoAsiento(), 
                                  busVirtual.getLargoAsiento(),
                                  this.bVisibleOcupado,
                                  this.bVisibleReservado,
