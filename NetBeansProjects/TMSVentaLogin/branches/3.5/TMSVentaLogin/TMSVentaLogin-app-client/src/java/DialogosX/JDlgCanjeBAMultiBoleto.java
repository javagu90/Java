...
public class JDlgCanjeBAMultiBoleto extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jLabel4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 743, Short.MAX_VALUE)
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jTxtFolioPreimpreso, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 655, Short.MAX_VALUE)
                        .addContainerGap())
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jCboServicio, 0, 231, Short.MAX_VALUE)
                            .add(jCboEmpresas, 0, 231, Short.MAX_VALUE))
                        .add(434, 434, 434))
                    .add(jPanel1Layout.createSequentialGroup()
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .add(jScpBoletoOriginal, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                .addContainerGap())
        );
         ...
         else
         {
          ...
          if(evt.getKeyCode() == evt.VK_ENTER)
          {
                    ...
                    boletos = sesionVenta.buscaBoletoAbiertoMult(jCboOrigen.getSelectedItem().toString(), conjuntoFolios, 
                            sesionVenta.getVectorServiciosReal(jCboServicio.getSelectedItem().toString()), jCboEmpresas.getSelectedItem().toString().substring((jCboEmpresas.getSelectedItem().toString().indexOf("-")) + 1),
