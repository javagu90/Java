...
public interface TmsVtaFacadeRemote {
    ...
    long[] CancelaBoletoRemoto(String pDBLink, String Campos1, String Valores1, String Campos2, String Valores2, String claveCorrida, long noAsiento, long boletoIdOriginal) throws javax.ejb.EJBException;

    long CancelaBoletoLocal(String Campos1, String Valores1, String claveCorrida, long noAsiento, long boletoIdOriginal) throws javax.ejb.EJBException;
  ...
  //  boolean BuscaBoletoValidoparaFT(String pDBSchema, String pDBLink, String Origen, String FolioPreimpreso, String noAsiento, String nombreEmpresa) throws javax.ejb.EJBException;
    ...
    java.lang.String _solicitudRegistroVentaSP3(String nuevo_strBoletos, String pqry, int tam);
    ...
    String Registra_Transaccion_Lealtad(String operacion, String pDBLink);

    boolean importeSuficiente(String noTarjeta, long usuario, String usrkey, double importeACubrir);

    boolean usarWSLealtad();

    String GetParametrosTAE(long EMPRESA_ID, long SERVICIO_ID, long TERMINAL_ID, long RUTA_ID, long CAJA_ID);

    public boolean validaTarjetaNoPermitida(java.lang.String noTarjeta);

    public java.lang.String obtener_valor_parametro_misc(java.lang.String parametro, long EMPRESA_ID, long SERVICIO_ID, long TERMINAL_ID, long RUTA_ID, long CAJA_ID);

    public boolean getAplicaPromocion(double montoVa, double tarifaRedondo, double descuento, double tarifaSencillo, java.lang.String dia);

    public java.util.Vector getAgenciasViaje();

    public BigDecimal getClienteSEDENA();

    public java.util.Vector parametrosPorRutaPromocion(long terminalId);

    public java.lang.String getMesAnioBD();

    public boolean ventaJuconiActiva();

    public java.lang.String getNombreServicios();

    public boolean registrarVentaProducto(java.lang.String empresa, java.lang.String producto, long cantidad, java.lang.String folio, java.lang.String clave_producto, float precio_unitario, float subtotal, float iva, float total, float retencion, long corteId, java.lang.String caja, long cajero, java.lang.String terminal, long terminalId, long usuarioId, java.lang.String tipoPago,String IdentificadorAdicional);

    public java.lang.String getGeneraFolioPreimpreso(long terminalId);

    public java.util.Vector getEstados();

    public java.util.Vector getProductoCargo(java.lang.String pclaveProducto);

    public java.util.Vector rutasConPromocionRedondoTTP();

    public java.util.Vector getImpresora(java.lang.String caja);

    public java.lang.String getTicketCompra(long terminalId);

    public int validaServicioCodigoBarras(java.lang.String servicio);
