...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String user, pass;
        Coneccion cbd= new Coneccion();
        user=(String)request.getParameter("usuario");
        pass=(String)request.getParameter("pass");
        boolean acess=cbd.acesso(user, pass);
        sesion=request.getSession();
        if(acess==true && (sesion.getAttribute("usuario")==null))
        {
            sesion.setAttribute("usuario", user);
            String tipo=cbd.tipoUser(user);
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    sesion.invalidate();
                    response.sendRedirect("caduca.html");
                }
            }
