...
// BUSQUEDA DE ASIENTO
    ...
    //INSERTAR COMPONENTE
    public boolean insertarComponente(int iTipo, String nombre, int iDespuesDeAsiento){
        switch(iTipo){
            ...
            case 1: if(this.buscarCompoAereo(iDespuesDeAsiento)){ this.setError(5); return false; }
                    ...
                    this.InsertarCompoAero(1, nombre,iDespuesDeAsiento,this.iPX,this.iPZ);
                    return true;
        }
      return true;
    }
    ...
    private void InsertarCompoAero(int iTipo, String nombre, int iDespuesDeAsiento, int pX, int pZ){
