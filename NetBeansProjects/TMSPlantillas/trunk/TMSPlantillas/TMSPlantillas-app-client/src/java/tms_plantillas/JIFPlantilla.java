    ...
    private void jbtnAgregar_actionPerformed(ActionEvent e) {
        try{
          ...
          if(iCompo>-1){
              ...
              System.out.println("AGREGAR TIPO "+datos[iCompo][2].toString()+" - "+datos[iCompo][3].toString()+" - "+datos[iCompo][1].toString());
              ...
              if(ubicacion!=null){
                ...
                System.out.println(" insertarComponente "+datos[iCompo][3]);
                if(x.insertarComponente(iTipo, datos[iCompo][0], iAsiento, Integer.parseInt(datos[iCompo][3]+"")) ){
