...
public class Compo {
    ...
    /**
     * @return the Comp_Bus_id
     */
    public int getComp_Bus_id() {
        return Comp_Bus_id;
    }

    /**
     * @param Comp_Bus_id the Comp_Bus_id to set
     */
    public void setComp_Bus_id(int Comp_Bus_id) {
        this.Comp_Bus_id = Comp_Bus_id;
    }
}
