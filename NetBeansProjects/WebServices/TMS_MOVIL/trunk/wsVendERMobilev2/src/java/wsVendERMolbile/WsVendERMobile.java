...
public class WsVendERMobile {
    ...
    public WsVendERMobile(){
        ...
        System.out.println("Version de WS 2.3.9");
    }
     ...
     */
    @WebMethod
    public Vector registrarSesionActividad(@WebParam(name = "opcion") int opcion,
            @WebParam(name = "valor") String valor, @WebParam(name = "valorOpcional") String valorOpcional,
            @WebParam(name = "cajaNombre") String cajaNombre, @WebParam(name = "uid") String uid) {
        return vendERMobileFacadeBean.registrarSesionActividad(opcion, valor, valorOpcional, cajaNombre, uid);
    }
