...
public Token(Vector val){
   ...
   this.clienteId=new BigDecimal(val.get(1).toString());
    ...
    this.mesVencimiento=val.get(6)==null?null:BigInteger.valueOf(Long.valueOf(val.get(6).toString()));
    this.anioVencimiento=val.get(7)==null?null:BigInteger.valueOf(Long.valueOf(val.get(7).toString()));
    this.adicional1=val.get(8)==null?"":val.get(8).toString();
    this.adicional2=val.get(9)==null?"":val.get(9).toString();
    this.adicional3=val.get(10)==null?"":val.get(10).toString();
    this.adicional4=val.get(11)==null?"":val.get(11).toString();
    this.adicional5=val.get(12)==null?"":val.get(12).toString();}
    ...
    /**
     * @param mesVencimiento the mesVencimiento to set
     */
    ...
    /**
     * @param anioVencimiento the anioVencimiento to set
     */
