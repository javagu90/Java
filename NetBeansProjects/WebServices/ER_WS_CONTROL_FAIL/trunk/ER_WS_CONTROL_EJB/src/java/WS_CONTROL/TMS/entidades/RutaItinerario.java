 ...
 * @author brojas
 */
public class RutaItinerario implements Serializable {
private Long	 Ruta_ID;
     ...
     */
    public void setTramo(List<Tramo> Tramo) {
        this.Tramo = Tramo;
    }
    ...
    /**
     * @param tarifaAdulto the tarifaAdulto to set
     */
