 ...
 *
 * Root class para hacer la definicion de Campos comunes
 * OperacionExitosa
 * ErrorCode
 * ErrorMsg
 */
...
public class ExchangeResp implements Serializable{
    ...
    public void printContent() throws Exception{
        ...
        //TODO: manipular motodo para que no solo tome la superclase inmediata, sino todo el camino para la
        //obtencion de los campos a mostrar
        Object ob = this;
