...
public void asignarTramos ( List<TramoRuta> listTramo)
{
    this.TramoRuta=listTramo;
}


public void asignarUnidades ( List<Unidad> listUnidad)
{
    this.Unidad=listUnidad;
}

    /**
     * @return the total_kmts
     */
    public double getTotal_kmts() {
        return total_kmts;
    }

    /**
     * @param total_kmts the total_kmts to set
     */
    public void setTotal_kmts(double total_kmts) {
        this.total_kmts = total_kmts;
    }
}
