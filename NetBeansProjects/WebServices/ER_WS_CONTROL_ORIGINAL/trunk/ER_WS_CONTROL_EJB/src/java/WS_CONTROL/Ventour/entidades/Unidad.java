...
public class Unidad implements Serializable{
    ...
    /**
     * @param refrigerio the refrigerio to set
     */
    ...
    /**
     * @return the no_refrigerios
     */
    public int getNo_refrigerios() {
        return no_refrigerios;
    }

    /**
     * @param no_refrigerios the no_refrigerios to set
     */
    public void setNo_refrigerios(int no_refrigerios) {
        this.no_refrigerios = no_refrigerios;
    }
