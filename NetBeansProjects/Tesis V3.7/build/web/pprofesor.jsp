        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="#" id="zero" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-bell"></span> Notificaciones <span class="badg badg-info" id="n" ></span></a>
                        <script>
     ...
     function refreshN()
				...
				$.ajax({
					...
					error: function(){
                                ...
                                setInterval(refreshN,  99000);
                            }
                            
		$(document).ready(function () {
                    refreshN();
                    $("a#zero").click(function()
                                {
                                    $.ajax({
                                        url:"SetZero",
                                        success:function(msg)
...
<div class="modal fade bs-example-modal-lg" id="ventanaR1" >
  ...
  <form method="post" id="formularioA1" enctype="multipart/form-data">
      Subir archivo: (Espere la respuesta del servidor para concluir su actividad) <input type="file" name="filevid">
</form>
            <div id="respuesta1">Respuesta del Servidor: </div>
        </div>
        <form class="formularioActividad1" name="formularioActividad1">
...
<div class="modal fade bs-example-modal-lg" id="ventanaR2" >
  ...
  <form method="post" id="formularioA2" enctype="multipart/form-data">
      Subir archivo:(Espere la respuesta del servidor para concluir su actividad) <input type="file"  name="fileimg">
</form>
            <div id="respuesta">Respuesta del Servidor: </div>
        </div>
        <form class="formularioActividad2" name="formularioActividad2">
		...
		$(document).ready(function () {
				...
				$.ajax({
					...
					error: function(){
                             ...
                             setInterval(refreshPublicaciones, 1000);
			});
            </script>
