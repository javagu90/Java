...
public class Coneccion 
{
        ...
        try
	{
           ...
           conexion = DriverManager.getConnection("jdbc:mysql://localhost/mydb", "javagu90", "heil"); //mybd javagu9 avefenix
            //conexion = DriverManager.getConnection("jdbc:mysql://localhost/webmilab_mybd", "webmilab_javagu9", "avefenix"); //mybd javagu9 avefenix
    ...
    public boolean cambiarUser(String userViejo, String userNuevo, String userNuevoR, String pass)
    {
        ...
        try
        {
            ...
            rs.next();
            String userpass=rs.getString("password");
            System.out.println("REPETIDO?: "+repetido(userNuevo));
            System.out.println("PASS IGUALES?: "+ userpass.equals(pass)+" "+userpass+":"+pass);
            System.out.println("long user: "+userNuevo.length() );
            System.out.println("users IGUALES?: "+ userNuevo.equals(userNuevoR)+" "+userNuevo+":"+userNuevoR);
    ...
    public boolean cambiarPass(String usuario, String passViejo, String passNuevo, String passNuevoR)
    {
        ...
        try
        {
            ...
            System.out.println("considen pas antiguos?: "+ userpass.equals(passViejo)+" "+userpass+":"+passViejo);
            System.out.println("long pass: "+passNuevo.length() );
            System.out.println("pass nuevos IGUALES?: "+ passNuevo.equals(passNuevoR)+" "+passNuevo+":"+passNuevoR);
...
public boolean cambiarDatos(String nombre, String apellidos, String correo, String pass, String usuario)
{
    ...
    try
    {
     ...
     String userpass=rs.getString("password");
                 ...
                 System.out.println("considen pass?: "+ userpass.equals(pass)+" "+userpass+":"+pass);
            System.out.println("long nombre: "+nombre.length() );
            System.out.println("long apellido: "+apellidos.length() );
            System.out.println("long correo: "+correo.length() );
...
{
    int numNotificaciones=(int)(Math.random()*(10-1+1)+1);
    /*try
    {
