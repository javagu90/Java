        ...
        try {
         ...
         for(Object item:items){
             ...
             if(!uploaded.isFormField())
             {
                 ...
                 File fichero=new File("/home/webmilab/SGOAs/apache-tomcat-7.0.59/webapps/Tesis_V3.7/imgOas/", uploaded.getName());
                 try {
                 ...
                 out.println("Estado del archivo: <b>Archivo cargado con EXITO</b>");
                 ...
                 out.println("");*/
                     ...
                     try (PrintWriter out = response.getWriter()) {
                     out.println("Estado del archivo: <b>ERROR AL CARGAR EL ARCHIVO... INTENTELO DE NUEVO POR FAVOR</b>");
                     }
                 }
