...
public class JDlgSysCboStandr extends javax.swing.JDialog implements KeyListener{
    ...
    public JDlgSysCboStandr(boolean[] pBtx, SesionVenta pSesionVenta, String pAMEXP, String pSalidaImpresion, String pAutorizacion, String pNumOperacion, boolean ejecutaFuncion, RelojVisualVta pThX){
        this.thX = pThX;
        ...
        this.importe = "$"+sesionVenta.customFormat("##,##0.00",sesionVenta.getImporteVenta());
...
//                }
    ...
    private void mostrarResultado(boolean imprimible){
        ...
        if(stTx.equals("approved")){
            ...
            else msg += "Error en transacción ("+jClsPinPadTBResponse.getRspCdError()+").<br>Vuelva a realizar el cobro";
            success=false;
        }
        this.referencia = sesionVenta.getUserCon().getUsuarioNum()+""+new SimpleDateFormat("ddMMyyHHmmss").format(this.thX.getFecha().getTime());
        msg += "</html>";
