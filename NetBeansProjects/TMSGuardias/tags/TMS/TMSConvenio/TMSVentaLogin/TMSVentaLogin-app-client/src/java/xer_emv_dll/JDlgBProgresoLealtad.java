...
import DialogosX.JDlgAcumulaEstrellas;
 ...
 * @author  ocruz
 */
public class JDlgBProgresoLealtad extends javax.swing.JDialog {
    
    /** Creates new form JDlgBProgreso */
    public JDlgBProgresoLealtad(JObsBProgreso pModelo, final JDlgAcumulaEstrellas met) {
        this.setModal(false);
        initComponents();
        interfazColor();
        centrarJDialog();
