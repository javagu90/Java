...
public class xeremvcls {
    ...
    public JClsPinPadTBResponse validarEMVDll(JClsPinPadTBRequest x) {
        ...
        System.out.println(""+x.getDbgSetUrl()+" -- "+x.getTx_Amount()+" -- "+x.getBs_User()+" -- "+x.getBs_Pwd()+" -- "+x.getBs_UsrTransaction()+" -- "+x.getBs_Company()+" -- "+x.getBs_Branch()+" -- "+x.getBs_Country()+" -- "+x.getCc_Type()+" -- "+x.getCc_Name()+" -- "+
