...
public class ValidateCancelarBoletosReq extends MainValidator{
    ...
    public Object validar(InvocationContext ic ) throws Exception{
        ...
        motivoCancelación = cancelarBoletosReq.getMotivoCancelación();
    ...
    private boolean isValidMotivoCancelación(String mCancelación) throws Exception{
    ...
    public boolean checkRequired() throws Exception{
        if ((this.isValidSesionId(sesionID))&&
                ...
                (this.isValidMotivoCancelación(motivoCancelación)))
            return true;
        else
            return false;
    }
