...
public class JDLG_BusquedaNombre extends javax.swing.JDialog {
    Color focusado;
    Color noFocusado;    
    private TmsSesionBeanFacturarRemote facade;
    ...
    JIF_Facturar facturar;
    public String fecha="";
            
    /** Creates new form JDLG_BusquedaNombre */
    public JDLG_BusquedaNombre(java.awt.Frame parent, boolean modal, TmsSesionBeanFacturarRemote facade,JIF_Facturar facturar ){
        super(parent, modal);
        ...
        buscadosHeader.add("Folio Preimpreso");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(jlbl_barraEstado, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 567, Short.MAX_VALUE)
    ...
    private void jtbl_buscadosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtbl_buscadosKeyPressed
        if(evt.getKeyCode() == evt.VK_ESCAPE){
            ...
            if(evt.getKeyCode() == evt.VK_ENTER){
               facturar.setFolioPreimpreso(jtbl_buscados.getValueAt(jtbl_buscados.getSelectedRow(), 0).toString());
               facturar.buscarBoleto();
               this.dispose();
            }
    ...
    private void buscarBoleto() {
        ...
        jlbl_barraEstado.setText("<html>  <font color=FF0000>   ESC</font> Nueva Búsqueda | <font color=FF0000>   ENTER</font> Seleccinar Boleto para Facturar");
    }
