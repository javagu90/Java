...
@NamedQueries({
    ...
    @NamedQuery(name = "Pagoapartado.findByIdcaja", query = "SELECT p FROM Pagoapartado p WHERE p.caja.idcaja = :idcaja"),
    ...
    //@NamedQuery(name = "Pagoapartado.getMaxId", query="SELECT MAX(p.idpago) FROM Pagoapartado p"),
...
public class Pagoapartado implements Serializable {
	...
	public static String FIND_BY_ID_CAJA         = "Pagoapartado.findByIdcaja";
	...
	//public static String GET_MAX_ID				 = "Pagoapartado.getMaxId";
