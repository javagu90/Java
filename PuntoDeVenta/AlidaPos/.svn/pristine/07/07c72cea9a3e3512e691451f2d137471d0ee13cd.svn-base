...
public class PromocionFacade implements Serializable {
    ...
    public List<Promocion> findPromocionByCategoriaTiendaFecha(int idProduct, int idTienda) throws AlidaPosException {
    	try {
    		promocionDao.beginTransaction();
    		List<Promocion> result = promocionDao.findByCategoriaTiendaFecha(idProduct, idTienda);
    		promocionDao.closeTransaction();
    		return result;
    	} catch (Exception ex) {
    		try {
    ...
    public List<Promocion> findPromocionByProductTiendaFecha(int idProduct, int idTienda) throws AlidaPosException {
    	try {
    		promocionDao.beginTransaction();
    		List<Promocion> result = promocionDao.findByIdProductTiendaFecha(idProduct, idTienda);
    		promocionDao.closeTransaction();
    		return result;
    	} catch (Exception ex) {
    		try {
