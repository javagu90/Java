...
@NamedQueries({
    ...
    @NamedQuery(name = "Pagoventa.findByIdcaja", query = "SELECT p FROM Pagoventa p WHERE p.caja.idcaja = :idcaja"),
...
public class Pagoventa implements Serializable {
	...
	public static String FIND_BY_ID_CAJA         = "Pagoventa.findByIdcaja";
