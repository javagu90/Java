...
public class ClienteDao extends GenericDao<Cliente> implements Serializable {
	...
	public List<Cliente> findClienteByRfcLike(String query) throws AlidaPosException {
		Map<String, Object> parameters = new HashMap<String, Object>();
		String queryString = "SELECT c FROM Cliente c WHERE UPPER(c.persona.rfc) like UPPER(:rfc)";
		parameters.put("rfc", "%" + query + "%");
		return super.getListResultQuery(queryString, parameters);
	}
